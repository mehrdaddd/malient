...
var wrapInlineNodes = function (nodes) {
    ...
    return nodes.map(function (node) {
        return schema_2.inlineNodes.has(node.type)
...
var flattenUnknownBlockTree = function (node, schema, adfStage) {
    ...
    for (var i = 0; i < node.content.length; i++) {
        ...
        if (isLeafNode) {
            ...
            output.push.apply(output, flattenUnknownBlockTree(childNode, schema, adfStage));
        }
...
exports.getValidUnknownNode = function (node) {
    ...
    if (!content || !content.length) {
        ...
        if (textUrl && _1.isSafeUrl(textUrl)) {
        ...
        switch (type) {
            ...
            case 'decisionList': {
                return {
                    ...
                    content: content,
                    attrs: {
                        localId: (attrs && attrs.localId) || uuid_1.generateUuid(),
                    },
                };
            }
            case 'decisionItem': {
        ...
        switch (type) {
            ...
            case 'link': {
                if (attrs) {
                    ...
                    if (linkHref && _1.isSafeUrl(linkHref)) {
                        return {
                            type: type,
                            attrs: linkAttrs,
                        };
