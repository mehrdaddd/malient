    ...
    parseDOM: [
        {
            ...
            getAttrs: function (dom) {
                var attrs = {
                    id: dom.getAttribute('data-mention-id') || exports.mention.attrs.id.default,
                    text: dom.textContent || exports.mention.attrs.text.default,
                    accessLevel: dom.getAttribute('data-access-level') ||
                        exports.mention.attrs.accessLevel.default,
                };
