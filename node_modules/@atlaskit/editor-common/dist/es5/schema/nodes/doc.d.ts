 ...
 * @minItems 1
 */
export declare type TopLevel = Array<Panel | Paragraph | Blockquote | OrderedList | BulletList | Rule | Heading | CodeBlock | MediaGroup | MediaSingle | ApplicationCard | DecisionList | TaskList | Table | Extension | BodiedExtension>;
/**
 * @name table_cell_content
 * @minItems 1
 */
export declare type TableCellContent = Array<Panel | Paragraph | Blockquote | OrderedList | BulletList | Rule | Heading | CodeBlock | MediaGroup | MediaSingle | ApplicationCard | DecisionList | TaskList | Extension>;
/**
 * @name extension_content
 * @minItems 1
 */
export declare type ExtensionContent = Array<Panel | Paragraph | Blockquote | OrderedList | BulletList | Rule | Heading | CodeBlock | MediaGroup | MediaSingle | ApplicationCard | DecisionList | TaskList | Table | Extension>;
/**
 ...
 */
export declare type InlineFormattedText = Text & MarksObject<Link | Em | Strong | Strike | SubSup | Underline | TextColor | Action>;
/**
 ...
 */
export declare type InlineCode = Text & MarksObject<Code | Link>;
/**
 * @name atomic_inline_node
 */
export declare type InlineAtomic = HardBreak | Mention | Emoji | InlineExtension | Date | Placeholder;
/**
 * @name inline_node
 */
