...
var profilecard_1 = require("@atlaskit/profilecard");
...
var MentionWithProfileCard = /** @class */ (function (_super) {
    ...
    function MentionWithProfileCard() {
        ...
        _this.showProfilecard = function () {
            ...
            var _a = _this.calculateLayerPosition(), popupAlignX = _a[0], popupAlignY = _a[1];
            _this.setState({
    ...
    MentionWithProfileCard.prototype.getActions = function (id, text, accessLevel) {
        ...
        return actions.map(function (action) {
            return tslib_1.__assign({}, action, { callback: function (evt) {
                    _this.setState({ visible: false });
                    action.callback();
                } });
        });
    ...
    MentionWithProfileCard.prototype.render = function () {
        ...
        return (React.createElement("span", { ref: this.handleRef, onClick: this.showProfilecard },
            ...
            target &&
                portal &&
                visible && (React.createElement(Popup_1.default, { offset: [0, 8], target: target, mountTo: portal, alignX: popupAlignX, alignY: popupAlignY },
