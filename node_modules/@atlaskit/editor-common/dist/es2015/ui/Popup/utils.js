...
export function calculatePosition(_a) {
    ...
    var _c = target.getBoundingClientRect(), targetTop = _c.top, targetLeft = _c.left, targetRight = _c.right, targetHeight = _c.height, targetWidth = _c.width;
    ...
    if (horizontalPlacement === 'left') {
        ...
        var newTargetWidth = target.clientWidth || targetWidth;
