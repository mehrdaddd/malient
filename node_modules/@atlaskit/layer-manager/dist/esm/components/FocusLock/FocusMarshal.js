...
var FocusLockRegistry = function () {
  function FocusLockRegistry() {
    ...
    _classCallCheck(this, FocusLockRegistry);
    ...
    this.handleKeyDown = function (event) {
      ...
      var els = tabbable(_this.currentLock);
      var first = els[0];
  ...
  _createClass(FocusLockRegistry, [{
    key: 'polyfillFocusIn',
    ...
    value: function findFocusTarget(autoFocus) {
      ...
      if (focusFirstAvailable) {
        var els = tabbable(this.currentLock);
        return els[0];
      }
...
export default FocusLockRegistry;