...
var BitbucketWordmark = function (_Component) {
  _inherits(BitbucketWordmark, _Component);

  function BitbucketWordmark() {
    _classCallCheck(this, BitbucketWordmark);

    return _possibleConstructorReturn(this, (BitbucketWordmark.__proto__ || _Object$getPrototypeOf(BitbucketWordmark)).apply(this, arguments));
  }

  _createClass(BitbucketWordmark, [{
    key: 'render',
...
BitbucketWordmark.defaultProps = DefaultProps;
export default BitbucketWordmark;