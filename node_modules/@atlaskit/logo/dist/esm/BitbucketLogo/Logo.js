...
var BitbucketLogo = function (_Component) {
  _inherits(BitbucketLogo, _Component);

  function BitbucketLogo() {
    _classCallCheck(this, BitbucketLogo);

    return _possibleConstructorReturn(this, (BitbucketLogo.__proto__ || _Object$getPrototypeOf(BitbucketLogo)).apply(this, arguments));
  }

  _createClass(BitbucketLogo, [{
    key: 'render',
...
BitbucketLogo.defaultProps = DefaultProps;
