...
var ConfluenceIcon = function (_Component) {
  _inherits(ConfluenceIcon, _Component);

  function ConfluenceIcon() {
    _classCallCheck(this, ConfluenceIcon);

    return _possibleConstructorReturn(this, (ConfluenceIcon.__proto__ || _Object$getPrototypeOf(ConfluenceIcon)).apply(this, arguments));
  }

  _createClass(ConfluenceIcon, [{
    key: 'render',
...
ConfluenceIcon.defaultProps = DefaultProps;
