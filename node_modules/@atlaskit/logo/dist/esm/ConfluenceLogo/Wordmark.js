...
var ConfluenceWordmark = function (_Component) {
  _inherits(ConfluenceWordmark, _Component);

  function ConfluenceWordmark() {
    _classCallCheck(this, ConfluenceWordmark);

    return _possibleConstructorReturn(this, (ConfluenceWordmark.__proto__ || _Object$getPrototypeOf(ConfluenceWordmark)).apply(this, arguments));
  }

  _createClass(ConfluenceWordmark, [{
    key: 'render',
...
ConfluenceWordmark.defaultProps = DefaultProps;
export default ConfluenceWordmark;