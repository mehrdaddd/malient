...
var ConfluenceLogo = function (_Component) {
  _inherits(ConfluenceLogo, _Component);

  function ConfluenceLogo() {
    _classCallCheck(this, ConfluenceLogo);

    return _possibleConstructorReturn(this, (ConfluenceLogo.__proto__ || _Object$getPrototypeOf(ConfluenceLogo)).apply(this, arguments));
  }

  _createClass(ConfluenceLogo, [{
    key: 'render',
...
ConfluenceLogo.defaultProps = DefaultProps;
