...
var JiraWordmark = function (_Component) {
  _inherits(JiraWordmark, _Component);

  function JiraWordmark() {
    _classCallCheck(this, JiraWordmark);

    return _possibleConstructorReturn(this, (JiraWordmark.__proto__ || _Object$getPrototypeOf(JiraWordmark)).apply(this, arguments));
  }
...
JiraWordmark.defaultProps = DefaultProps;
export default JiraWordmark;