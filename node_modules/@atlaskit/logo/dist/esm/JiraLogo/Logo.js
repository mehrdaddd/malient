...
var JiraLogo = function (_Component) {
  _inherits(JiraLogo, _Component);

  function JiraLogo() {
    _classCallCheck(this, JiraLogo);

    return _possibleConstructorReturn(this, (JiraLogo.__proto__ || _Object$getPrototypeOf(JiraLogo)).apply(this, arguments));
  }

  _createClass(JiraLogo, [{
    key: 'render',
...
JiraLogo.defaultProps = DefaultProps;
