...
var StatuspageLogo = function (_Component) {
  _inherits(StatuspageLogo, _Component);

  function StatuspageLogo() {
    _classCallCheck(this, StatuspageLogo);

    return _possibleConstructorReturn(this, (StatuspageLogo.__proto__ || _Object$getPrototypeOf(StatuspageLogo)).apply(this, arguments));
  }

  _createClass(StatuspageLogo, [{
    key: 'render',
...
StatuspageLogo.defaultProps = DefaultProps;
export default StatuspageLogo;