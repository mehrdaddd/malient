...
var JiraCoreLogo = function (_Component) {
  _inherits(JiraCoreLogo, _Component);

  function JiraCoreLogo() {
    _classCallCheck(this, JiraCoreLogo);

    return _possibleConstructorReturn(this, (JiraCoreLogo.__proto__ || _Object$getPrototypeOf(JiraCoreLogo)).apply(this, arguments));
  }

  _createClass(JiraCoreLogo, [{
    key: 'render',
...
JiraCoreLogo.defaultProps = DefaultProps;
export default JiraCoreLogo;