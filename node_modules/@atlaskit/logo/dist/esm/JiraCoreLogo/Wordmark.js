...
var JiraCoreWordmark = function (_Component) {
  _inherits(JiraCoreWordmark, _Component);

  function JiraCoreWordmark() {
    _classCallCheck(this, JiraCoreWordmark);

    return _possibleConstructorReturn(this, (JiraCoreWordmark.__proto__ || _Object$getPrototypeOf(JiraCoreWordmark)).apply(this, arguments));
  }

  _createClass(JiraCoreWordmark, [{
    key: 'render',
...
JiraCoreWordmark.defaultProps = DefaultProps;
export default JiraCoreWordmark;