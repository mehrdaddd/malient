...
var JiraSoftwareLogo = function (_Component) {
  _inherits(JiraSoftwareLogo, _Component);

  function JiraSoftwareLogo() {
    _classCallCheck(this, JiraSoftwareLogo);

    return _possibleConstructorReturn(this, (JiraSoftwareLogo.__proto__ || _Object$getPrototypeOf(JiraSoftwareLogo)).apply(this, arguments));
  }

  _createClass(JiraSoftwareLogo, [{
    key: 'render',
...
JiraSoftwareLogo.defaultProps = DefaultProps;
export default JiraSoftwareLogo;