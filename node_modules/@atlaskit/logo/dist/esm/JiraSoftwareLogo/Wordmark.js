...
var JiraSoftwareWordmark = function (_Component) {
  _inherits(JiraSoftwareWordmark, _Component);

  function JiraSoftwareWordmark() {
    _classCallCheck(this, JiraSoftwareWordmark);

    return _possibleConstructorReturn(this, (JiraSoftwareWordmark.__proto__ || _Object$getPrototypeOf(JiraSoftwareWordmark)).apply(this, arguments));
  }

  _createClass(JiraSoftwareWordmark, [{
    key: 'render',
...
JiraSoftwareWordmark.defaultProps = DefaultProps;
export default JiraSoftwareWordmark;