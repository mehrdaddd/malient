...
var StrideWordmark = function (_Component) {
  _inherits(StrideWordmark, _Component);

  function StrideWordmark() {
    _classCallCheck(this, StrideWordmark);

    return _possibleConstructorReturn(this, (StrideWordmark.__proto__ || _Object$getPrototypeOf(StrideWordmark)).apply(this, arguments));
  }

  _createClass(StrideWordmark, [{
    key: 'render',
...
StrideWordmark.defaultProps = DefaultProps;
