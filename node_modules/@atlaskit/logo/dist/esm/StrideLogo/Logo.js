...
var StrideLogo = function (_Component) {
  _inherits(StrideLogo, _Component);

  function StrideLogo() {
    _classCallCheck(this, StrideLogo);

    return _possibleConstructorReturn(this, (StrideLogo.__proto__ || _Object$getPrototypeOf(StrideLogo)).apply(this, arguments));
  }

  _createClass(StrideLogo, [{
    key: 'render',
...
StrideLogo.defaultProps = DefaultProps;
