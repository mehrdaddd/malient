...
var AtlassianWordmark = function (_Component) {
  _inherits(AtlassianWordmark, _Component);

  function AtlassianWordmark() {
    _classCallCheck(this, AtlassianWordmark);

    return _possibleConstructorReturn(this, (AtlassianWordmark.__proto__ || _Object$getPrototypeOf(AtlassianWordmark)).apply(this, arguments));
  }

  _createClass(AtlassianWordmark, [{
    key: 'render',
...
AtlassianWordmark.defaultProps = DefaultProps;
