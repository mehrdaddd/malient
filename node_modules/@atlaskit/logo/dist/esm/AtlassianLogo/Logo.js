...
var AtlassianLogo = function (_Component) {
  _inherits(AtlassianLogo, _Component);

  function AtlassianLogo() {
    _classCallCheck(this, AtlassianLogo);

    return _possibleConstructorReturn(this, (AtlassianLogo.__proto__ || _Object$getPrototypeOf(AtlassianLogo)).apply(this, arguments));
  }

  _createClass(AtlassianLogo, [{
    key: 'render',
...
AtlassianLogo.defaultProps = DefaultProps;
