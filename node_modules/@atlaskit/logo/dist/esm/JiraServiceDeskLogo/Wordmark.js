...
var JiraServiceDeskWordmark = function (_Component) {
  _inherits(JiraServiceDeskWordmark, _Component);

  function JiraServiceDeskWordmark() {
    _classCallCheck(this, JiraServiceDeskWordmark);

    return _possibleConstructorReturn(this, (JiraServiceDeskWordmark.__proto__ || _Object$getPrototypeOf(JiraServiceDeskWordmark)).apply(this, arguments));
  }

  _createClass(JiraServiceDeskWordmark, [{
    key: 'render',
...
JiraServiceDeskWordmark.defaultProps = DefaultProps;
export default JiraServiceDeskWordmark;