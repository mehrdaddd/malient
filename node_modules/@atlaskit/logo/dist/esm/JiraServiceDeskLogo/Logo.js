...
var JiraServiceDeskLogo = function (_Component) {
  _inherits(JiraServiceDeskLogo, _Component);

  function JiraServiceDeskLogo() {
    _classCallCheck(this, JiraServiceDeskLogo);

    return _possibleConstructorReturn(this, (JiraServiceDeskLogo.__proto__ || _Object$getPrototypeOf(JiraServiceDeskLogo)).apply(this, arguments));
  }

  _createClass(JiraServiceDeskLogo, [{
    key: 'render',
...
JiraServiceDeskLogo.defaultProps = DefaultProps;
export default JiraServiceDeskLogo;