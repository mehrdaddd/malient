...
var HipchatLogo = function (_Component) {
  _inherits(HipchatLogo, _Component);

  function HipchatLogo() {
    _classCallCheck(this, HipchatLogo);

    return _possibleConstructorReturn(this, (HipchatLogo.__proto__ || _Object$getPrototypeOf(HipchatLogo)).apply(this, arguments));
  }

  _createClass(HipchatLogo, [{
    key: 'render',
...
HipchatLogo.defaultProps = DefaultProps;
export default HipchatLogo;