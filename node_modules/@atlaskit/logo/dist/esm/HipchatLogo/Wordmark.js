...
var HipchatWordmark = function (_Component) {
  _inherits(HipchatWordmark, _Component);

  function HipchatWordmark() {
    _classCallCheck(this, HipchatWordmark);

    return _possibleConstructorReturn(this, (HipchatWordmark.__proto__ || _Object$getPrototypeOf(HipchatWordmark)).apply(this, arguments));
  }

  _createClass(HipchatWordmark, [{
    key: 'render',
...
HipchatWordmark.defaultProps = DefaultProps;
export default HipchatWordmark;