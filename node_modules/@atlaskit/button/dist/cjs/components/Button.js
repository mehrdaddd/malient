...
var _LoadingSpinner = require('../styled/LoadingSpinner');
  ...
  (0, _createClass3.default)(Button, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        StyledComponent,
        (0, _extends3.default)({ innerRef: this.getInnerRef }, buttonProps),
        _react2.default.createElement(
          _ButtonWrapper2.default,
          { onClick: this.onInnerClick, fit: !!shouldFitContainer },
          isLoading ? _react2.default.createElement(_LoadingSpinner2.default, {
            spacing: spacing,
