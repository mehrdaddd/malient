...
var AvatarImage = function (_PureComponent) {
  ...
  function AvatarImage() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = AvatarImage.__proto__ || _Object$getPrototypeOf(AvatarImage)).call.apply(_ref2, [this].concat(args))), _this), _this.state = {
      hasError: false,
  ...
  _createClass(AvatarImage, [{
    ...
    value: function render() {
      ...
      return showDefault ? React.createElement(DefaultImage, { appearance: appearance, size: size, title: alt }) : React.createElement(Slot, {
        appearance: appearance,
        isLoading: isLoading,
        size: size,
        role: 'img',
