...
var _AvatarGroupItem = require('./AvatarGroupItem');

var _AvatarGroupItem2 = _interopRequireDefault(_AvatarGroupItem);
  ...
  (0, _createClass3.default)(AvatarGroup, [{
    ...
    value: function renderMoreDropdown(max, total) {
      ...
      var items = data.slice(max).map(function (avatar, index) {
        return _react2.default.createElement(_AvatarGroupItem2.default, {
          isInteractive: true,
          avatar: avatar,
          key: index,
