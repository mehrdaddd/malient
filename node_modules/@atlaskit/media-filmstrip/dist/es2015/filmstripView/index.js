...
var FilmstripView = /** @class */ (function (_super) {
    ...
    FilmstripView.prototype.render = function () {
        ...
        return (React.createElement(FilmStripViewWrapper, null,
            ...
            React.createElement(FilmStripListWrapper, { innerRef: this.handleWindowElementChange, onWheel: this.handleScroll },
                React.createElement(FilmStripList, { innerRef: this.handleBufferElementChange, style: { transform: transform, transitionProperty: transitionProperty, transitionDuration: transitionDuration } }, React.Children.map(children, mapReactChildToReactNode))),
