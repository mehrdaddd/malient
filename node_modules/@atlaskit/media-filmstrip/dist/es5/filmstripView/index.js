...
var arrow_left_1 = require("@atlaskit/icon/glyph/arrow-left");
var arrow_right_1 = require("@atlaskit/icon/glyph/arrow-right");
var debounce = require("debounce");
var styled_1 = require("./styled");
var DURATION_MIN = 0.5;
var DURATION_MAX = 1.0;
var EXTRA_PADDING = 4;
exports.MUTATION_CONFIG = {
    attributes: true,
    childList: true,
    subtree: true,
    characterData: true,
};
exports.LeftArrow = function (_a) {
    var onClick = _a.onClick;
    return (React.createElement(styled_1.ShadowLeft, null,
        React.createElement(styled_1.ArrowLeftWrapper, { className: "arrow", onClick: onClick },
            React.createElement(arrow_left_1.default, { label: "left" }))));
};
exports.RightArrow = function (_a) {
    var onClick = _a.onClick;
    return (React.createElement(styled_1.ShadowRight, null,
        React.createElement(styled_1.ArrowRightWrapper, { className: "arrow", onClick: onClick },
            React.createElement(arrow_right_1.default, { label: "right" }))));
};
var FilmstripView = /** @class */ (function (_super) {
    ...
    FilmstripView.prototype.initMutationObserver = function () {
        ...
        if (mutationObserver) {
            ...
            mutationObserver.observe(this.bufferElement, exports.MUTATION_CONFIG);
        }
    };
    ...
    FilmstripView.prototype.renderLeftArrow = function () {
        ...
        return React.createElement(exports.LeftArrow, { onClick: this.handleLeftClick });
    };
    FilmstripView.prototype.renderRightArrow = function () {
        ...
        return React.createElement(exports.RightArrow, { onClick: this.handleRightClick });
    };
    ...
    FilmstripView.prototype.componentDidUpdate = function () {
        ...
        setTimeout(function () { return _this.triggerScrollEvent(); }, this.transitionDuration * 1000);
    };
    FilmstripView.prototype.render = function () {
        ...
        return (React.createElement(styled_1.FilmStripViewWrapper, null,
            this.renderLeftArrow(),
            React.createElement(styled_1.FilmStripListWrapper, { innerRef: this.handleWindowElementChange, onWheel: this.handleScroll },
                React.createElement(styled_1.FilmStripList, { innerRef: this.handleBufferElementChange, style: { transform: transform, transitionProperty: transitionProperty, transitionDuration: transitionDuration } }, React.Children.map(children, mapReactChildToReactNode))),
...
function mapReactChildToReactNode(child, index) {
    ...
    return React.createElement(styled_1.FilmStripListItem, { key: key }, child);
}
