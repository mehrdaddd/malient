...
var Transition = /** @class */ (function (_super) {
    ...
    Transition.prototype.render = function () {
        ...
        return (React.createElement(Transition_1.default, { appear: true, enter: true, exit: true, in: visible, timeout: timeout, onExited: this.handleExited }, function (status) {
            if (children) {
