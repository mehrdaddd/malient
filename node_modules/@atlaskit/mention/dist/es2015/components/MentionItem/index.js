...
import { AvatarStyle, FullNameStyle, InfoSectionStyle, MentionItemStyle, NicknameStyle, NameSectionStyle, AccessSectionStyle, RowStyle, TimeStyle, } from './styles';
...
var MentionItem = /** @class */ (function (_super) {
    ...
    MentionItem.prototype.render = function () {
        ...
        var borderColor = selected ? akColorN30 : undefined;
        return (React.createElement(MentionItemStyle, { selected: selected, onMouseDown: this.onMentionSelected, onMouseMove: this.onMentionMenuItemMouseMove, "data-mention-id": id, "data-mention-name": mentionName },
            React.createElement(RowStyle, null,
                ...
                React.createElement(InfoSectionStyle, { restricted: restricted },
                    ...
                    renderTime(time)),
                restricted ? (React.createElement(Tooltip, { content: name + " won't be notified as they have no access", position: "right" },
                    React.createElement(AccessSectionStyle, null,
                        React.createElement(LockCircleIcon, { label: "No access" })))) : null)));
    };
    return MentionItem;
}(React.PureComponent));
