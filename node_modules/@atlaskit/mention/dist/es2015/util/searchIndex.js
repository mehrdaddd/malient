 ...
 */
export function mentionDescriptionComparator(inContextUsers) {
    return function (a, b) {
        var aIsSpecialMention = isSpecialMention(a);
        var bIsSpecialMention = isSpecialMention(b);
