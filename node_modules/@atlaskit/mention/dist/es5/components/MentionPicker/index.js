...
var ResourcedMentionList_1 = require("../ResourcedMentionList");
...
var MentionPicker = /** @class */ (function (_super) {
    ...
    MentionPicker.prototype.render = function () {
        ...
        var resourceMentionList = (React.createElement(ResourcedMentionList_1.default, { resourceProvider: resourceProvider, presenceProvider: presenceProvider, onSelection: onSelection, query: query, ref: this.handleMentionListRef }));
