...
var ResourcedMention = /** @class */ (function (_super) {
    ...
    ResourcedMention.prototype.render = function () {
        ...
        return (React.createElement(_1.default, { id: props.id, text: props.text, isHighlighted: state.isHighlighted, accessLevel: props.accessLevel, onClick: props.onClick, onMouseEnter: props.onMouseEnter, onMouseLeave: props.onMouseLeave }));
    };
