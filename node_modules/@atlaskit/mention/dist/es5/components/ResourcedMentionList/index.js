...
var MentionList_1 = require("../MentionList");
...
var ResourcedMentionList = /** @class */ (function (_super) {
    ...
    ResourcedMentionList.prototype.render = function () {
        ...
        return (React.createElement(MentionList_1.default, { mentions: mentions, resourceError: resourceError, onSelection: this.notifySelection, ref: this.handleMentionListRef }));
    };
