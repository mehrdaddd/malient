...
var AbstractReactionsResource = /** @class */ (function () {
    function AbstractReactionsResource() {
        ...
        this.debounced = null;
        this.loadingStatus = {
            status: types_1.ReactionStatus.loading,
        };
        this.errorStatus = {
            status: types_1.ReactionStatus.error,
    ...
    AbstractReactionsResource.prototype.findReaction = function (key, emojiId) {
        ...
        return index !== -1 &&
            reactionState &&
            reactionState.status === types_1.ReactionStatus.ready
            ? reactionState.reactions[index]
            : undefined;
    };
    AbstractReactionsResource.prototype.findReactionIndex = function (key, emojiId) {
        var reactionState = this.cachedReactions[key];
        if (reactionState && reactionState.status === types_1.ReactionStatus.ready) {
    ...
    AbstractReactionsResource.prototype.unsubscribe = function (subscriptionKey, handler) {
        ...
        var index = helpers_1.findIndex(this.subscribers[key], function (listener) { return listener.handler === handler; });
        if (index !== -1) {
            this.subscribers[key].splice(index, 1);
        }
    };
    AbstractReactionsResource.prototype.queueAri = function (subscriptionKey) {
        var index = helpers_1.findIndex(this.batchedKeys, function (i) {
    ...
    AbstractReactionsResource.prototype.optimisticAddReaction = function (containerAri, ari, emojiId) {
        ...
        var reactionState = this.cachedReactions[key];
        if (reactionState.status === types_1.ReactionStatus.ready) {
            var reactionIndex = this.findReactionIndex(key, emojiId);
            if (reactionIndex !== -1) {
                reactionState.reactions = helpers_1.updateReadonlyArray(reactionState.reactions, reactionIndex, function (previous) {
...
exports.default = AbstractReactionsResource;
