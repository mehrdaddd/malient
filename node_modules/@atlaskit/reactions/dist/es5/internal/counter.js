...
var Counter = /** @class */ (function (_super) {
    ...
    function Counter(props) {
        ...
        _this.renderPrevious = function () {
            ...
            if (previous !== undefined) {
                var className = cx((_a = {}, _a[exports.highlightStyle] = previous.highlight, _a));
    ...
    Counter.prototype.render = function () {
        var _a = this.props, value = _a.value, highlight = _a.highlight, classNameProp = _a.className;
        ...
        var enterClass = increase
            ...
            : decrease ? exports.slideDownStyle : undefined;
        var className = cx(exports.countStyle, classNameProp);
        var currentClassName = cx((_b = {}, _b[exports.highlightStyle] = highlight, _b));
