...
var reactions_resource_1 = require("./reactions-resource");
...
var MockReactionsProvider = /** @class */ (function (_super) {
    ...
    function MockReactionsProvider() {
        ...
        _this.cachedReactions = (_a = {},
            _a[_this.objectReactionKey('ari:cloud:owner:demo-cloud-id:container/1', 'ari:cloud:owner:demo-cloud-id:item/1')] = {
                status: reactions_resource_1.ReactionStatus.ready,
                reactions: [
                    {
                        ari: 'ari:cloud:owner:demo-cloud-id:item/1',
                        containerAri: 'ari:cloud:owner:demo-cloud-id:container/1',
                        emojiId: selector_1.defaultReactionsByShortName.get(':fire:').id,
                        count: 1,
                        reacted: true,
                    },
                    {
                        ari: 'ari:cloud:owner:demo-cloud-id:item/1',
                        containerAri: 'ari:cloud:owner:demo-cloud-id:container/1',
                        emojiId: selector_1.defaultReactionsByShortName.get(':thumbsup:')
                            .id,
                        count: 9,
                        reacted: false,
                    },
                    {
                        ari: 'ari:cloud:owner:demo-cloud-id:item/1',
                        containerAri: 'ari:cloud:owner:demo-cloud-id:container/1',
                        emojiId: selector_1.defaultReactionsByShortName.get(':thumbsdown:').id,
                        count: 5,
                        reacted: false,
                    },
                    {
                        ari: 'ari:cloud:owner:demo-cloud-id:item/1',
                        containerAri: 'ari:cloud:owner:demo-cloud-id:container/1',
                        emojiId: selector_1.defaultReactionsByShortName.get(':heart_eyes:').id,
                        count: 100,
                        reacted: false,
                    },
                ],
    ...
    MockReactionsProvider.prototype.getReactions = function (keys) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            Object.keys(_this.cachedReactions).forEach(function (cacheKey) {
                ...
                if (objectReactions.status === reactions_resource_1.ReactionStatus.ready) {
    ...
    MockReactionsProvider.prototype.fetchReactionDetails = function (reaction) {
        ...
        return new Promise(function (resolve, reject) {
            _this.getDetailedReaction(reaction).then(function (reactionDetails) {
                ...
                if (reactionsState.status === reactions_resource_1.ReactionStatus.ready) {
                    var reactionIndex_1 = helpers_1.findIndex(reactionsState.reactions, function (r) { return r.emojiId === emojiId; });
                    setTimeout(function () {
                        if (reactionIndex_1 !== -1) {
                            reactionsState.reactions = helpers_1.updateReadonlyArray(reactionsState.reactions, reactionIndex_1, function (_) { return reactionDetails; });
                        }
                        else {
    ...
    MockReactionsProvider.prototype.addReaction = function (containerAri, ari, emojiId) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            var reactionsState = _this.cachedReactions[key];
            if (reactionsState.status === reactions_resource_1.ReactionStatus.ready) {
                var index = helpers_1.findIndex(reactionsState.reactions, function (reaction) {
                    return helpers_1.equalEmojiId(reaction.emojiId, emojiId);
                });
                if (index !== -1) {
    ...
    MockReactionsProvider.prototype.deleteReaction = function (containerAri, ari, emojiId) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            var reactionsState = _this.cachedReactions[key];
            if (reactionsState.status === reactions_resource_1.ReactionStatus.ready) {
                var index_1 = helpers_1.findIndex(reactionsState.reactions, function (reaction) {
                    return helpers_1.equalEmojiId(reaction.emojiId, emojiId);
                });
...
}(reactions_resource_1.default));
exports.default = MockReactionsProvider;
exports.reactionsProvider = new MockReactionsProvider();
exports.reactionsProviderPromise = Promise.resolve(exports.reactionsProvider);
