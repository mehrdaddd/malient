export declare type ReactionsState = ReactionsReadyState | ReactionsLoading | ReactionsError;
...
export declare type SubscriptionHandler = (state: ReactionsState) => void;
export interface ReactionsProvider {
    ...
    addReaction(containerAri: string, ari: string, emojiId: string): Promise<ReactionsState>;
    deleteReaction(containerAri: string, ari: string, emojiId: string): Promise<ReactionsState>;
    ...
    subscribe(objectReactionKey: ObjectReactionKey, handler: SubscriptionHandler): void;
    unsubscribe(objectReactionKey: ObjectReactionKey, handler: SubscriptionHandler): void;
}
