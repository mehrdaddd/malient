...
export declare class TimerFactory implements Core.TimerFactoryInterop {
    ...
    constructor(onTick: TimerTickHandler, timerStarter?: TimerStarter | undefined, timerStopper?: TimerStopper | undefined);
    unload(): void;
    createTimer(): number;
    startTimer(id: number, msecInterval: number): void;
    stopTimer(id: number): void;
    private unloadTimer(id);
    private static defaultStarter(callback, msecInterval);
    private static defaultStopper(handle);
}
