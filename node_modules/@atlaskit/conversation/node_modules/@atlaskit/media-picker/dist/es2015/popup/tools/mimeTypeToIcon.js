...
import { akColorY200, akColorY400, akColorG300, akColorR300, akColorR400, akColorP200, akColorB75, akColorB200, akColorN200, } from '@atlaskit/util-shared-styles';
...
export var mapMimeTypeToIcon = function (mimeType) {
    if (isFolder(mimeType)) {
        return (React.createElement(IconWrapper, { color: akColorB75 },
            React.createElement(FolderFilledIcon, { label: "folder" })));
    }
    else if (isImage(mimeType)) {
        return (React.createElement(IconWrapper, { color: akColorY200 },
            React.createElement(ImageIcon, { label: "image" })));
    }
    else if (isVideo(mimeType)) {
        return (React.createElement(IconWrapper, { color: akColorR300 },
            React.createElement(VideoIcon, { label: "video" })));
    }
    else if (isAudio(mimeType)) {
        return (React.createElement(IconWrapper, { color: akColorP200 },
            React.createElement(AudioIcon, { label: "audio" })));
    }
    else if (isSpreadsheet(mimeType)) {
        return (React.createElement(IconWrapper, { color: akColorG300 },
            React.createElement(SpreadSheetIcon, { label: "spreadsheet" })));
    }
    else if (isPresentation(mimeType)) {
        return (React.createElement(IconWrapper, { color: akColorY400 },
            React.createElement(PresentationIcon, { label: "presentation" })));
    }
    else if (isDocument(mimeType)) {
        return (React.createElement(IconWrapper, { color: akColorB200 },
            React.createElement(DocumentIcon, { label: "document" })));
    }
    else if (isPDF(mimeType)) {
        return (React.createElement(IconWrapper, { color: akColorR400 },
            React.createElement(PDFDocumentIcon, { label: "pdf document" })));
    }
    else if (isArchive(mimeType)) {
        return (React.createElement(IconWrapper, { color: akColorN200 },
            React.createElement(ZipDocumentIcon, { label: "zip" })));
    }
    else {
        return (React.createElement(IconWrapper, { color: akColorN70 },
