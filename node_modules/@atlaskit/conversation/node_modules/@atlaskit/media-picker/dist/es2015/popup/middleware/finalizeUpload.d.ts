...
export declare function finalizeUpload(fetcher: Fetcher, store: Store<State>, {file, uploadId, source, tenant}: FinalizeUploadAction): Promise<SendUploadEventAction>;
