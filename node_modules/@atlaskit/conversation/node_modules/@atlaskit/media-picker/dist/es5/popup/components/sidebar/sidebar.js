...
var upload_1 = require("@atlaskit/icon/glyph/upload");
var dropbox_1 = require("@atlaskit/icon/glyph/dropbox");
var googledrive_1 = require("@atlaskit/icon/glyph/googledrive");
var sidebarItem_1 = require("./item/sidebarItem");
var giphySidebarItem_1 = require("./item/giphySidebarItem");
    ...
    StatelessSidebar.prototype.render = function () {
        ...
        return (React.createElement(styled_1.Wrapper, null,
            React.createElement(styled_1.ServiceList, null,
                React.createElement(sidebarItem_1.default, { serviceName: "upload", serviceFullName: "Upload", isActive: selected === 'upload' },
