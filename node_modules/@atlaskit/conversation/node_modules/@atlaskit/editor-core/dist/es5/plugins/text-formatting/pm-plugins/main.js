...
var transform_to_code_1 = require("../commands/transform-to-code");
var TextFormattingState = /** @class */ (function () {
    ...
    TextFormattingState.prototype.toggleCode = function (view) {
        ...
        if (code) {
            if (!this.codeActive) {
                view.dispatch(transform_to_code_1.transformToCodeAction(view.state, from, to));
                return true;
            }
            return prosemirror_commands_1.toggleMark(code)(view.state, view.dispatch);
        }
        return false;
    };
    ...
    TextFormattingState.prototype.update = function (newEditorState) {
        ...
        if (code) {
            ...
            var newCodeDisabled = !prosemirror_commands_1.toggleMark(code)(this.state);
        ...
        if (em) {
            ...
            var newEmDisabled = !prosemirror_commands_1.toggleMark(em)(this.state);
        ...
        if (strike) {
            ...
            var newStrikeDisabled = !prosemirror_commands_1.toggleMark(strike)(this.state);
        ...
        if (strong) {
            ...
            var newStrongDisabled = !prosemirror_commands_1.toggleMark(strong)(this.state);
        ...
        if (subsup) {
            ...
            var newSubscriptDisabled = !prosemirror_commands_1.toggleMark(subsup, { type: 'sub' })(this.state);
            ...
            var newSuperscriptDisabled = !prosemirror_commands_1.toggleMark(subsup, { type: 'sup' })(this.state);
            if (this.codeActive ||
        ...
        if (underline) {
            ...
            var newUnderlineDisabled = !prosemirror_commands_1.toggleMark(underline)(this.state);
    ...
    TextFormattingState.prototype.textInputHandler = function (view, from, to, text) {
        ...
        if (state.selection.empty) {
            ...
            if (charBefore === '`' && charAfter === '`') {
                ...
                view.dispatch(transform_to_code_1.transformToCodeAction(state, from - 1, from, tr));
                return true;
            }
        }
        return false;
    ...
    TextFormattingState.prototype.toggleMark = function (view, markType, attrs) {
        ...
        if (this.codeActive ? this.codeDisabled : true) {
            return prosemirror_commands_1.toggleMark(markType, attrs)(view.state, view.dispatch);
        }
        return false;
    };
    return TextFormattingState;
}());
exports.TextFormattingState = TextFormattingState;
exports.stateKey = new prosemirror_state_1.PluginKey('textFormatting');
exports.plugin = new prosemirror_state_1.Plugin({
    ...
    view: function (view) {
        ...
        pluginState.keymapHandler = keymap_1.default(view, pluginState);
        return {};
    },
    props: {
        handleKeyDown: function (view, event) {
            return exports.stateKey.getState(view.state).keymapHandler(view, event);
        },
        handleTextInput: function (view, from, to, text) {
            return exports.stateKey
                .getState(view.state)
