...
var FloatingToolbar = styled_components_1.default(FloatingToolbar_1.default)(templateObject_1 || (templateObject_1 = tslib_1.__makeTemplateObject(["\n  max-height: 350px;\n  min-height: 32px;\n  height: initial;\n  & > div {\n    line-height: 1;\n  }\n  & > div > button:last-child {\n    margin-right: 0;\n  }\n  .normal& input {\n    min-width: 244px;\n    margin-right: 2px;\n  }\n  .recent-search& {\n    padding: 8px 0 0;\n    input {\n      padding: 0 8px 8px;\n    }\n  }\n"], ["\n  max-height: 350px;\n  min-height: 32px;\n  height: initial;\n  & > div {\n    line-height: 1;\n  }\n  & > div > button:last-child {\n    margin-right: 0;\n  }\n  .normal& input {\n    min-width: 244px;\n    margin-right: 2px;\n  }\n  .recent-search& {\n    padding: 8px 0 0;\n    input {\n      padding: 0 8px 8px;\n    }\n  }\n"])));
// `a&` because `Button` uses it and it produces a more specific selector `a.xyz`
var ToolbarButton = styled_components_1.default(ToolbarButton_1.default)(templateObject_2 || (templateObject_2 = tslib_1.__makeTemplateObject(["\n  width: 24px;\n  padding: 0;\n  margin: 0 2px;\n  a& {\n    width: 24px;\n    margin: 0 2px;\n  }\n"], ["\n  width: 24px;\n  padding: 0;\n  margin: 0 2px;\n  a& {\n    width: 24px;\n    margin: 0 2px;\n  }\n"])));
// Need fixed height because parent has height inherit and `height: 100%` doesn't work because of that
var Separator = styled_components_1.default(Separator_1.default)(templateObject_3 || (templateObject_3 = tslib_1.__makeTemplateObject(["\n  margin: 2px 6px;\n  height: 20px;\n"], ["\n  margin: 2px 6px;\n  height: 20px;\n"])));
    ...
    HyperlinkEdit.prototype.render = function () {
        ...
        if ((active || showToolbarPanel) && (editorFocused || inputActive)) {
            ...
            return (React.createElement(FloatingToolbar, { alignX: "left", target: popupTarget, offset: [0, 12], fitHeight: renderRecentSearch ? 350 : 32, onPositionCalculated: this.adjustPosition, popupsBoundariesElement: popupsBoundariesElement, popupsMountPoint: popupsMountPoint, className: renderRecentSearch ? 'recent-search' : 'normal' },
                ...
                showOpenButton && (React.createElement(ToolbarButton, { spacing: "compact", href: href, target: "_blank", title: "Open link", iconBefore: React.createElement(open_1.default, { label: "Open link" }) })),
                showUnlinkButton && (React.createElement(ToolbarButton, { spacing: "compact", onClick: this.handleUnlink, title: "Unlink", iconBefore: React.createElement(unlink_1.default, { label: "Unlink" }) }))));
        }
        else {
            return null;
        }
