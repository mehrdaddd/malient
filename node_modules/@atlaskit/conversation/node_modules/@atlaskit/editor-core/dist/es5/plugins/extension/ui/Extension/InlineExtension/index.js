...
var InlineExtension = /** @class */ (function (_super) {
    ...
    InlineExtension.prototype.render = function () {
        var _a = this.props, node = _a.node, onClick = _a.onClick, children = _a.children;
        var hasChildren = !!children;
        var className = hasChildren
            ? 'with-overlay with-children'
            : 'with-overlay';
        return (React.createElement(styles_2.Wrapper, { onClick: onClick, className: "extension-container " + className },
