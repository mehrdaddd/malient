...
var MediaComponentInternal = /** @class */ (function (_super) {
    ...
    MediaComponentInternal.prototype.renderLoadingCard = function (mediaItemType, url) {
        ...
        return (React.createElement(media_card_1.CardView, { status: "loading", mediaItemType: mediaItemType, dimensions: cardDimensions }));
    };
    MediaComponentInternal.prototype.renderLink = function () {
        ...
        if (onDelete) {
            otherProps.actions = [exports.createDeleteAction(onDelete)];
        }
        return (React.createElement(media_card_1.Card, tslib_1.__assign({ context: linkCreateContext, dimensions: cardDimensions, identifier: identifier, appearance: appearance || 'horizontal', resizeMode: this.resizeMode, disableOverlay: disableOverlay }, otherProps)));
    };
    ...
    MediaComponentInternal.prototype.renderPublicFile = function () {
        ...
        return (React.createElement(media_card_1.Card, tslib_1.__assign({ context: viewContext, dimensions: cardDimensions, identifier: {
                id: id,
                mediaItemType: 'file',
                collectionName: collection,
    ...
    MediaComponentInternal.prototype.renderTemporaryFile = function () {
        ...
        var isImageFile = utils_1.isImage(fileMimeType);
        ...
        return (React.createElement(media_card_1.CardView
        // CardViewProps
        , tslib_1.__assign({ 
            // CardViewProps
    ...
    MediaComponentInternal.prototype.renderExternal = function () {
        ...
        return (React.createElement(media_card_1.CardView, tslib_1.__assign({ status: imageStatus || 'loading', metadata: {
                mediaType: 'image',
                name: url,
...
exports.MediaComponentInternal = MediaComponentInternal;
exports.createDeleteAction = function (eventHander) {
    return {
        label: 'Delete',
        handler: eventHander,
        icon: React.createElement(cross_1.default, { size: "small", label: "delete" }),
    };
};
exports.default = editor_common_1.withImageLoader(MediaComponentInternal);
