 ...
 */
exports.getBrowserInfo = function (nAgt) {
    var browserName;
    var browserVersion;
    var nameOffset;
    var verOffset;
 ...
 */
exports.getDeviceInfo = function (nAgt, nVersion) {
    var os = '';
    var osVersion = '';
    var clientStrings = [
    ...
    function ToolbarFeedback() {
        ...
        _this.openFeedbackPopup = function () {
            ...
            window.ATL_JQ_PAGE_PROPS = {
                ...
                fieldValues: {
                    description: "Please describe the problem you're having or feature you'd like to see:\n\n\n---~---~---~---~---~---~---~---~---~---~---~---~---~---~---\n version: " + _this.props.packageName + "@" + _this.props.packageVersion + " (" + package_json_1.version + ")\n product: " + product + "\n---~---~---~---~---~---~---~---~---~---~---~---~---~---~---\nBrowser: " + exports.getBrowserInfo(navigator.userAgent) + "\nOS: " + exports.getDeviceInfo(navigator.userAgent, navigator.appVersion) + "\n---~---~---~---~---~---~---~---~---~---~---~---~---~---~---\n\n\n        ",
                },
                environment: {
                    'Editor Package': _this.props.packageName,
                    'Editor Version': _this.props.packageVersion,
                    'Editor Core Version': package_json_1.version,
                },
            };
            ...
            this.state.showOptOutOption && (React.createElement(PopupWithOutsideListeners, { target: this.state.target, mountTo: popupsMountPoint, boundariesElement: popupsBoundariesElement, scrollableElement: popupsScrollableElement, fitHeight: POPUP_HEIGHT, fitWidth: POPUP_WIDTH, handleClickOutside: this.toggleShowOptOutOption, handleEscapeKeydown: this.toggleShowOptOutOption },
                React.createElement(styles_1.ConfirmationPopup, null,
                    ...
                    React.createElement(styles_1.ConfirmationText, null,
                        ...
                        React.createElement("div", null, "You can opt-out for now in Bitbucket labs by turning off the \"Atlassian editor\" feature in settings."),
