...
var ReactEditorView = /** @class */ (function (_super) {
    ...
    function ReactEditorView(props) {
        ...
        _this.createEditorState = function (options) {
            ...
            _this.config = create_editor_1.processPluginsList(_this.getPlugins(options.props.editorProps), options.props.editorProps);
            ...
            var plugins = create_editor_1.createPMPlugins(_this.config, schema, options.props.editorProps, dispatch, _this.eventDispatcher, options.props.providerFactory, errorReporter);
            ...
            var selection = doc ? prosemirror_state_1.Selection.atEnd(doc) : undefined;
    ...
    ReactEditorView.prototype.getPlugins = function (editorProps) {
        return create_plugins_list_1.default(editorProps);
    };
