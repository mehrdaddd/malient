...
var MessageEditor = styled_components_1.default.div(templateObject_3 || (templateObject_3 = tslib_1.__makeTemplateObject(["\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: flex-end;\n  border: 1px solid\n    ", ";\n  border-radius: 3px;\n  height: auto;\n  min-height: 34px;\n  box-sizing: border-box;\n  word-wrap: break-word;\n  animation: ", ";\n\n  &.-flash {\n    animation: 0.25s ease-in-out ", ";\n  }\n\n  div > .ProseMirror {\n    outline: none;\n    white-space: pre-wrap;\n    padding: 0;\n    margin: 0;\n  }\n"], ["\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: flex-end;\n  border: 1px solid\n    ",
    ";\n  border-radius: 3px;\n  height: auto;\n  min-height: 34px;\n  box-sizing: border-box;\n  word-wrap: break-word;\n  animation: ",
    ";\n\n  &.-flash {\n    animation: 0.25s ease-in-out ", ";\n  }\n\n  div > .ProseMirror {\n    outline: none;\n    white-space: pre-wrap;\n    padding: 0;\n    margin: 0;\n  }\n"])), function (props) {
...
var ToolbarArea = styled_components_1.default(ContentStyles_1.default)(templateObject_5 || (templateObject_5 = tslib_1.__makeTemplateObject(["\n  display: flex;\n  width: ", ";\n"], ["\n  display: flex;\n  width: ", ";\n"])), function (props) { return (props.isMultiline ? '100%' : 'auto'); });
var SecondaryToolbarContainer = styled_components_1.default.div(templateObject_6 || (templateObject_6 = tslib_1.__makeTemplateObject(["\n  padding: 2px 4px 0 0;\n  margin-bottom: -1px;\n  box-sizing: border-box;\n  justify-content: flex-end;\n  align-items: flex-end;\n  flex-shrink: 0;\n  display: flex;\n"], ["\n  padding: 2px 4px 0 0;\n  margin-bottom: -1px;\n  box-sizing: border-box;\n  justify-content: flex-end;\n  align-items: flex-end;\n  flex-shrink: 0;\n  display: flex;\n"])));
var Editor = /** @class */ (function (_super) {
    ...
    function Editor() {
        ...
        _this.renderChrome = function (_a) {
            ...
            return (React.createElement(MessageEditor, { className: _this.flashToggle ? '-flash' : '', isMaxContentSizeReached: maxContentSizeReached, onClick: _this.focusEditor },
                React.createElement(ContentArea, { maxHeight: maxHeight, isMultiline: isMultilineContent },
