...
function createPlugin(analyticDelegateProps, providerFactory) {
    return new prosemirror_state_1.Plugin({
        props: {
            nodeViews: {
                taskItem: taskItem_1.taskItemNodeViewFactory(analyticDelegateProps, providerFactory),
                decisionItem: decisionItem_1.decisionItemNodeView,
            },
        },
                ...
                newState.doc.descendants(function (node, pos) {
                    ...
                    if (!!node.type &&
                        ...
                        if (localId === undefined || localId === null || localId === '') {
                            tr.setNodeMarkup(pos, undefined, tslib_1.__assign({ localId: editor_common_1.uuid.generate() }, rest));
                            modified = true;
                        }
                    }
                });
