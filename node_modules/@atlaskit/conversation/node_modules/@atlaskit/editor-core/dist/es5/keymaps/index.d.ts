...
export declare function tooltip(keymap: Keymap | undefined, compact?: boolean): string | undefined;
...
export declare function bindKeymapWithCommand(shortcut: string, cmd: (state: EditorState, dispatch: (tr: Transaction) => void, editorView?: EditorView) => boolean, keymap: {
    [key: string]: Function;
}): void;
