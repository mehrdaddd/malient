...
var ToolbarInsertBlock = /** @class */ (function (_super) {
    ...
    function ToolbarInsertBlock() {
        ...
        _this.createItems = function () {
            ...
            if (linkSupported) {
                items.push({
                    ...
                    tooltipDescription: keymaps_1.tooltip(keymaps_1.addLink),
                    tooltipPosition: 'right',
                    elemBefore: React.createElement(link_1.default, { label: "Add link" }),
                });
            }
            ...
            if (imageUploadSupported) {
                items.push({
                    ...
                    tooltipPosition: 'right',
                    elemBefore: React.createElement(image_1.default, { label: "Insert image" }),
                });
            }
            if (mentionsSupported) {
                items.push({
                    ...
                    tooltipPosition: 'right',
                    elemBefore: React.createElement(mention_1.default, { label: "Add mention" }),
                });
            }
            if (emojiProvider) {
                items.push({
                    ...
                    tooltipPosition: 'right',
                    elemBefore: React.createElement(emoji_1.default, { label: "Insert emoji" }),
            ...
            if (horizontalRuleEnabled &&
                ...
                items.push({
                    ...
                    tooltipPosition: 'right',
                    elemBefore: React.createElement(horizontal_rule_1.default, { label: "Insert horizontal rule" }),
                });
            }
            if (dateEnabled) {
                items.push({
                    ...
                    tooltipPosition: 'right',
                    elemBefore: React.createElement(date_1.default, { label: "Insert date" }),
                });
            }
            if (placeholderTextEnabled) {
                items.push({
                    ...
                    tooltipPosition: 'right',
                    elemBefore: React.createElement(text_1.default, { label: "Add placeholder text" }),
                });
            }
            if (layoutSectionEnabled) {
                items.push({
                    ...
                    tooltipPosition: 'right',
                    elemBefore: React.createElement(text_1.default, { label: "Insert columns" }),
                });
            }
            if (insertMenuItems) {
                ...
                items.push({
                    ...
                    tooltipPosition: 'right',
                    elemBefore: React.createElement(more_1.default, { label: "View more" }),
                });
            }
            return items;
        };
        ...
        _this.createDate = function () {
            var editorView = _this.props.editorView;
            actions_1.insertDate()(editorView.state, editorView.dispatch);
            actions_1.openDatePicker(editorView.domAtPos.bind(editorView))(editorView.state, editorView.dispatch);
            return true;
        };
        ...
        _this.insertLayoutColumns = function () {
            var editorView = _this.props.editorView;
            actions_3.insertLayoutColumns(editorView.state, editorView.dispatch);
            return true;
        };
        ...
        _this.insertHorizontalRule = function () {
            var editorView = _this.props.editorView;
            editorView.dispatch(input_rule_1.createHorizontalRule(editorView.state, editorView.state.selection.from, editorView.state.selection.to));
            return true;
        };
    ...
    ToolbarInsertBlock.prototype.render = function () {
        ...
        var toolbarButtonFactory = function (disabled, items) { return (React.createElement(ToolbarButton_1.default, { ref: function (el) { return _this.handleDropDownButtonRef(el, items); }, selected: isOpen, disabled: disabled, onClick: _this.handleTriggerClick, spacing: isReducedSpacing ? 'none' : 'default', iconBefore: React.createElement(styles_2.TriggerWrapper, null,
    ...
    tslib_1.__decorate([
        analytics_1.analyticsDecorator('atlassian.fabric.mention.picker.trigger.button')
    ], ToolbarInsertBlock.prototype, "insertMention", void 0);
    tslib_1.__decorate([
        analytics_1.analyticsDecorator('atlassian.editor.format.table.button')
    ], ToolbarInsertBlock.prototype, "createTable", void 0);
    tslib_1.__decorate([
        analytics_1.analyticsDecorator('atlassian.editor.format.date.button')
    ], ToolbarInsertBlock.prototype, "createDate", void 0);
    tslib_1.__decorate([
        analytics_1.analyticsDecorator('atlassian.editor.format.placeholder.button')
    ], ToolbarInsertBlock.prototype, "createPlaceholderText", void 0);
    tslib_1.__decorate([
        analytics_1.analyticsDecorator('atlassian.editor.format.layout.button')
    ], ToolbarInsertBlock.prototype, "insertLayoutColumns", void 0);
    tslib_1.__decorate([
        analytics_1.analyticsDecorator('atlassian.editor.format.media.button')
    ], ToolbarInsertBlock.prototype, "openMediaPicker", void 0);
    tslib_1.__decorate([
        analytics_1.analyticsDecorator('atlassian.editor.format.horizontalrule.button')
