...
exports.fixCursorAlignment = function (view) {
    ...
    var targetNodePos = side === 1 /* LEFT */ ? $from.pos + 1 : prosemirror_utils_1.findPositionOfNodeBefore(selection);
    ...
    if (targetNode.type === schema.nodes.table) {
        height -= editor_common_1.tableMarginTop + editor_common_1.tableMarginBottom;
        marginTop = editor_common_1.tableMarginTop;
    }
    // breakout mode
