...
declare const _default: new (props: Props & ImageLoaderProps, context?: any) => {
    ...
    onError: () => void;
    render(): JSX.Element;
    setState<K extends "imageStatus">(state: ImageLoaderState | Pick<ImageLoaderState, K> | ((prevState: Readonly<ImageLoaderState>, props: Props & ImageLoaderProps) => ImageLoaderState | Pick<ImageLoaderState, K> | null) | null, callback?: (() => void) | undefined): void;
