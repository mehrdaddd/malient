        ...
        state: {
            ...
            apply: function (tr, prevPluginState, oldState, newState) {
                ...
                if (collabEditProvider) {
                    ...
                    var participantsChanged = prevActiveParticipants !== activeParticipants;
                    if ((sessionId && selectionChanged && !tr.docChanged) ||
                        ...
                        // can go before it
                        setTimeout(collabEditProvider.sendMessage.bind(collabEditProvider), 0, {
                            type: 'telepointer',
                            selection: selection,
                            sessionId: sessionId,
                        });
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            collabEditProvider
                                ...
                                isReady = true;
                                actions_1.handleInit(data, view);
                            })
                                .on('connected', function (data) { return actions_1.handleConnection(data, view); })
                                .on('data', function (data) { return actions_1.applyRemoteData(data, view); })
...
var getValidPos = function (tr, pos) {
    ...
    var validSelection = prosemirror_state_1.Selection.findFrom(resolvedPos, -1, true);
    ...
    PluginState.prototype.apply = function (tr) {
        ...
        if (telepointerData) {
            ...
            if (sessionId && sessionId !== sid) {
                ...
                var from = getValidPos(tr, isSelection ? Math.max(rawFrom - 1, 0) : rawFrom);
                var to = isSelection ? getValidPos(tr, rawTo) : from;
