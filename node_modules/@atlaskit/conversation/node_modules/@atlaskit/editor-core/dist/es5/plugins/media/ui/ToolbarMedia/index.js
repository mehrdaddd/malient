...
var ToolbarMedia = /** @class */ (function (_super) {
    ...
    ToolbarMedia.prototype.render = function () {
        ...
        return (React.createElement(ToolbarButton_1.default, { onClick: this.handleClickMediaButton, disabled: isDisabled, title: "Insert files and images", spacing: isReducedSpacing ? 'none' : 'default', iconBefore: React.createElement(attachment_1.default, { label: "Insert files and images" }) }));
    };
