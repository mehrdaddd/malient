...
var CodeBlockState = /** @class */ (function () {
    ...
    CodeBlockState.prototype.updateLanguage = function (language, view) {
        if (this.activeCodeBlock) {
            prosemirror_commands_1.setBlockType(view.state.schema.nodes.codeBlock, {
                language: language,
    ...
    CodeBlockState.prototype.removeCodeBlock = function (view) {
        ...
        dispatch(prosemirror_utils_1.removeParentNodeOfType(schema.nodes.codeBlock)(tr));
        view.focus();
    };
    ...
    CodeBlockState.prototype.activeCodeBlockElement = function (domAtPos) {
        ...
        var codeDOM = prosemirror_utils_1.findParentDomRefOfType(codeBlock, domAtPos)(selection);
        return codeDOM
    ...
    CodeBlockState.prototype.activeCodeBlockNode = function () {
        var _a = this.state, selection = _a.selection, codeBlock = _a.schema.nodes.codeBlock;
        var parent = prosemirror_utils_1.findParentNodeOfType(codeBlock)(selection);
        if (parent) {
            return parent.node;
        }
    };
...
exports.stateKey = new prosemirror_state_1.PluginKey('codeBlockPlugin');
exports.plugin = new prosemirror_state_1.Plugin({
    ...
    view: function (editorView) {
        ...
        exports.stateKey.getState(editorView.state).update(editorView.state, domAtPos);
        return {
            update: function (view, prevState) {
                exports.stateKey.getState(view.state).update(view.state, domAtPos);
            },
        };
    },
    props: {
