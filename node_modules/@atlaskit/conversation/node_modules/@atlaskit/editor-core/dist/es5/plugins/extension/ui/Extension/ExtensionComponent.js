...
var ExtensionComponent = /** @class */ (function (_super) {
    ...
    function ExtensionComponent() {
        ...
        _this.handleSelectExtension = function () {
            var _a = _this.props.editorView, state = _a.state, dispatch = _a.dispatch;
            dispatch(prosemirror_utils_1.selectParentNodeOfType(state.schema.nodes.bodiedExtension)(state.tr));
        };
    ...
    ExtensionComponent.prototype.render = function () {
        ...
        switch (node.type.name) {
            ...
            case 'bodiedExtension':
                return (React.createElement(Extension_1.default, { node: node, macroProvider: macroProvider, onClick: this.selectExtension, handleContentDOMRef: handleContentDOMRef, onSelectExtension: this.handleSelectExtension }, extensionHandlerResult));
            case 'inlineExtension':
                return (React.createElement(InlineExtension_1.default, { node: node, macroProvider: macroProvider, onClick: this.selectExtension }, extensionHandlerResult));
            default:
                return null;
        }
    };
