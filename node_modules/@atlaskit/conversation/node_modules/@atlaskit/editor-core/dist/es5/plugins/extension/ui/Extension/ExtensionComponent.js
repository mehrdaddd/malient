    ...
    ExtensionComponent.prototype.render = function () {
        ...
        switch (node.type.name) {
            ...
            case 'bodiedExtension':
                return (React.createElement(Extension_1.default, { node: node, macroProvider: macroProvider, onClick: this.handleClick, handleContentDOMRef: handleContentDOMRef, onSelectExtension: this.handleSelectExtension }, extensionHandlerResult));
            case 'inlineExtension':
                return (React.createElement(InlineExtension_1.default, { node: node, macroProvider: macroProvider, onClick: this.handleClick }, extensionHandlerResult));
            default:
                return null;
        }
    };
