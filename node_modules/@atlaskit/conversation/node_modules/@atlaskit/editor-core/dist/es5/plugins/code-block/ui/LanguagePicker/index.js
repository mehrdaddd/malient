...
var LanguagePicker = /** @class */ (function (_super) {
    ...
    LanguagePicker.prototype.render = function () {
        ...
        if (toolbarVisible || languageSelectFocused) {
            return (React.createElement(styles_1.FloatingToolbar, { target: element, offset: [0, 12] },
                ...
                React.createElement(styles_1.TrashToolbarButton, { onClick: this.handleRemoveCodeBlock, title: "Remove code block", iconBefore: React.createElement(remove_1.default, { label: "Remove code block" }) })));
        }
        return null;
    };
