...
var MediaSingleNode = /** @class */ (function (_super) {
    ...
    MediaSingleNode.prototype.render = function () {
        ...
        return (React.createElement(MediaSingle, { layout: layout, width: width, height: height, containerWidth: this.props.width, isLoading: !width }, React.cloneElement(this.child, {
            cardDimensions: {
                width: '100%',
                height: '100%',
            },
