...
import { getEditorValueWithMedia, insertFileFromDataUrl, preprocessDoc, toJSON, processRawValue, } from '../utils';
...
var EditorActions = /** @class */ (function () {
    ...
    EditorActions.prototype._privateGetEventDispathcer = function () {
    ...
    EditorActions.prototype.getValue = function () {
        var _this = this;
        return getEditorValueWithMedia(this.editorView).then(function (doc) {
            var processedDoc = preprocessDoc(_this.editorView.state.schema, doc);
            if (_this.contentTransformer && processedDoc) {
                return _this.contentTransformer.encode(processedDoc);
            }
