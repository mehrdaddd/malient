...
import { akColorN40A, akColorB100, akColorB300, akColorB75, akColorN20, akColorN50, akColorR50, akColorR300, akColorR75, } from '@atlaskit/util-shared-styles';
import { tableSharedStyle, tableMarginTop, tableMarginBottom, akEditorTableNumberColumnWidth, } from '@atlaskit/editor-common';
import { scrollbarStyles } from '../../../ui/styles';
export var tableToolbarColor = akColorN20;
export var tableBorderColor = akColorN50;
export var tableFloatingControlsColor = akColorN20;
export var tableCellSelectedColor = akColorB75;
export var tableToolbarSelectedColor = akColorB100;
export var tableBorderSelectedColor = akColorB300;
export var tableCellDeleteColor = akColorR50;
export var tableBorderDeleteColor = akColorR300;
export var tableToolbarDeleteColor = akColorR75;
export var tableToolbarSize = 12;
export var tableBorderRadiusSize = 3;
export var tableInsertColumnButtonSize = 20;
export var tableDeleteColumnButtonSize = 16;
...
export var tableFullPageEditorStyles = "\n  .ProseMirror .table-container table {\n    .selectedCell.danger, .hoveredCell.danger {\n      border: 1px solid " + tableBorderDeleteColor + ";\n      background: " + tableCellDeleteColor + ";\n    }\n    .selectedCell.danger:after {\n      background: " + tableCellDeleteColor + ";\n    }\n    margin-left: 0;\n    margin-right: 0;\n    width: 100%;\n  }\n";
export var tableCommentEditorStyles = "\n  .ProseMirror .table-container table {\n    margin-left: 0;\n    margin-right: 0;\n\n    " + scrollbarStyles + ";\n  }\n";
