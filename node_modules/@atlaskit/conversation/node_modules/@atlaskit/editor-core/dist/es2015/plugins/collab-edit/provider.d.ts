...
import { InitData, ConnectionData, RemoteData, TelepointerData, PresenceData } from './types';
export declare type CollabEvent = 'init' | 'connected' | 'data' | 'telepointer' | 'presence' | 'error';
...
export interface CollabEditProvider {
    ...
    sendMessage<T extends keyof CollabEventData>(data: {
        type: T;
    } & CollabEventData[T]): any;
}
