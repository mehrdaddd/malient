...
var CommentEditor = styled.div(templateObject_3 || (templateObject_3 = tslib_1.__makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n\n  min-width: 272px;\n  /* Border + Toolbar + Footer + (Paragraph + ((Parahraph + Margin) * (DefaultLines - 1)) */\n  /* calc(2px + 40px + 24px + ( 20px + (32px * 2))) */\n  min-height: 150px;\n  height: auto;\n  ", " background-color: white;\n  border: 1px solid ", ";\n  box-sizing: border-box;\n  border-radius: ", ";\n\n  max-width: inherit;\n  word-wrap: break-word;\n\n  animation: ", ";\n\n  &.-flash {\n    animation: 0.25s ease-in-out ", ";\n  }\n"], ["\n  display: flex;\n  flex-direction: column;\n\n  min-width: 272px;\n  /* Border + Toolbar + Footer + (Paragraph + ((Parahraph + Margin) * (DefaultLines - 1)) */\n  /* calc(2px + 40px + 24px + ( 20px + (32px * 2))) */\n  min-height: 150px;\n  height: auto;\n  ",
    " background-color: white;\n  border: 1px solid ", ";\n  box-sizing: border-box;\n  border-radius: ", ";\n\n  max-width: inherit;\n  word-wrap: break-word;\n\n  animation: ",
    ";\n\n  &.-flash {\n    animation: 0.25s ease-in-out ", ";\n  }\n"])), function (props) {
    return props.maxHeight
        ? 'max-height: ' + props.maxHeight + 'px;'
        : '';
}, akColorN40, akBorderRadius, function (props) {
...
// tslint:disable-next-line:variable-name
var ContentArea = styled(ContentStyles)(templateObject_6 || (templateObject_6 = tslib_1.__makeTemplateObject(["\n  flex-grow: 1;\n  overflow-x: hidden;\n  overflow-y: auto;\n  line-height: 24px;\n\n  /** Hack for Bitbucket to ensure entire editorView gets drop event; see ED-3294 **/\n  /** Hack for tables controlls. Otherwise marging collapse and controlls are misplaced. **/\n  .ProseMirror {\n    padding: 0 12px;\n  }\n\n  padding: ", "px;\n\n  ", ";\n"], ["\n  flex-grow: 1;\n  overflow-x: hidden;\n  overflow-y: auto;\n  line-height: 24px;\n\n  /** Hack for Bitbucket to ensure entire editorView gets drop event; see ED-3294 **/\n  /** Hack for tables controlls. Otherwise marging collapse and controlls are misplaced. **/\n  .ProseMirror {\n    padding: 0 12px;\n  }\n\n  padding: ", "px;\n\n  ", ";\n"])), TableControlsPadding, tableCommentEditorStyles);
ContentArea.displayName = 'ContentArea';
// tslint:disable-next-line:variable-name
var SecondaryToolbar = styled.div(templateObject_7 || (templateObject_7 = tslib_1.__makeTemplateObject(["\n  box-sizing: border-box;\n  justify-content: flex-end;\n  align-items: center;\n  display: flex;\n  padding: 12px 1px;\n"], ["\n  box-sizing: border-box;\n  justify-content: flex-end;\n  align-items: center;\n  display: flex;\n  padding: 12px 1px;\n"])));
    ...
    function Editor() {
        ...
        _this.renderChrome = function (_a) {
            ...
            return (React.createElement("div", null,
                React.createElement(CommentEditor, { className: _this.flashToggle ? '-flash' : '', isMaxContentSizeReached: maxContentSizeReached, maxHeight: maxHeight },
