...
var LanguagePicker = /** @class */ (function (_super) {
    ...
    LanguagePicker.prototype.render = function () {
        ...
        if (toolbarVisible || languageSelectFocused) {
            return (React.createElement(FloatingToolbar, { target: element, offset: [0, 12] },
                ...
                React.createElement(TrashToolbarButton, { onClick: this.handleRemoveCodeBlock, title: "Remove code block", iconBefore: React.createElement(RemoveIcon, { label: "Remove code block" }) })));
        }
        return null;
    };
