...
var extensionPlugin = {
    ...
    contentComponent: function (_a) {
        ...
        return (React.createElement(WithPluginState, { plugins: {
                ...
                return (React.createElement(ExtensionEditPanel, { element: extensionState.element, onEdit: function () { return editExtension(macroState.macroProvider)(editorView); }, onRemove: function () { return removeExtension(editorView.state, dispatch); }, stickToolbarToBottom: extensionState.stickToolbarToBottom }));
            } }));
    },
};
