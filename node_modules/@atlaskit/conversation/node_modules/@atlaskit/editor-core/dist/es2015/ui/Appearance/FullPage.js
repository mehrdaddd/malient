...
var Editor = /** @class */ (function (_super) {
    ...
    function Editor() {
        ...
        _this.scheduleUpdateToolbarKeyline = function () {
            _this.scheduledKeylineUpdate = rafSchedule(function () {
                ...
                React.createElement(ClickAreaBlock, { editorView: editorView },
                    React.createElement(ContentArea, null,
                        React.createElement("div", { style: { padding: "0 " + GUTTER_PADDING + "px" }, className: "content-area" },
                            ...
                            editorDOMElement)))),
            React.createElement(WidthDetector, { editorView: editorView })));
    };
