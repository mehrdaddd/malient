...
import { posOfPreceedingMediaGroup, posOfMediaGroupNearby, posOfParentMediaGroup, isSelectionNonMediaBlockNode, isInsidePotentialEmptyParagraph, copyOptionalAttrsFromMediaState, } from './media-common';
    ...
    if (shouldSplit) {
        ...
        if (!deleteRange) {
            ...
            tr
                ...
                .insert(mediaInsertPos, content_1);
        }
        else {
            tr
                .insert(mediaInsertPos, content_1)
...
var createMediaFileNodes = function (mediaStates, collection, media) {
    var nodes = mediaStates.map(function (mediaState) {
        ...
        var node = media.create({ id: id, type: 'file', collection: collection, __key: id });
