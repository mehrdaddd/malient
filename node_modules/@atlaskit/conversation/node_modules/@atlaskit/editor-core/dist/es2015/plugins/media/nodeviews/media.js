...
var MediaNode = /** @class */ (function (_super) {
    ...
    MediaNode.prototype.render = function () {
        ...
        if (!width &&
            ...
            isMediaSingle &&
            type !== 'external') {
            return (React.createElement(ProgressLoader, { progress: progress, maxWidth: akEditorFullPageMaxWidth, onCancel: this.cancelProgress, cancelLabel: "Cancel upload" }));
        }
        return (React.createElement(UIMedia, { key: "media-node-" + __key, editorView: view, id: id, tempId: __key, type: type, collection: collection, providers: providerFactory, cardDimensions: cardDimensions, onDelete: deleteEventHandler, selected: selected, url: url, onExternalImageLoaded: onExternalImageLoaded, disableOverlay: isMediaSingle }));
    };
    return MediaNode;
}(Component));
