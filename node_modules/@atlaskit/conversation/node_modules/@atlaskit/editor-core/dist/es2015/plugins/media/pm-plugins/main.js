...
import { copyPrivateMediaAttributes, } from '@atlaskit/editor-common';
import analyticsService from '../../../analytics/service';
import { ErrorReporter, isImage } from '../../../utils';
import DropPlaceholder from '../ui/Media/DropPlaceholder';
import { insertLinks, detectLinkRangesInSteps, } from '../utils/media-links';
...
var MediaPluginState = /** @class */ (function () {
    function MediaPluginState(state, options, editorAppearance) {
        ...
        this.insertFiles = function (mediaStates) {
            ...
            var nonImageAttachements = mediaStates.filter(function (media) { return !isImage(media.fileMimeType); });
            ...
            if (_this.editorAppearance !== 'message' && mediaSingle) {
                insertMediaGroupNode(_this.view, nonImageAttachements, collection);
    ...
    MediaPluginState.prototype.initPickers = function (uploadParams, context, Picker) {
        ...
        if (!pickers.length) {
            ...
            var featureFlags = this.mediaProvider.featureFlags;
            var defaultPickerConfig = {
                useNewUploadService: !!(featureFlags && featureFlags.useNewUploadService),
...
export var createPlugin = function (schema, options, dispatch, editorAppearance) {
