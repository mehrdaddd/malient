...
var comment_1 = require("@atlaskit/comment");
...
exports.DeletedMessage = function () { return React.createElement("em", null, "Comment deleted by the author"); };
...
var Comment = /** @class */ (function (_super) {
    ...
    Comment.prototype.getContent = function () {
        ...
        if (comment.deleted) {
            return React.createElement(exports.DeletedMessage, null);
        }
        if (isEditing) {
            return (React.createElement(Editor_1.default, { defaultValue: comment.document.adf, isExpanded: true, isEditing: isEditing, onSave: this.onSaveEdit, onCancel: this.onCancelEdit, dataProviders: dataProviders, user: user, renderEditor: renderEditor, disableScrollTo: disableScrollTo, allowFeedbackAndHelpButtons: allowFeedbackAndHelpButtons }));
        }
        return (React.createElement(renderer_1.ReactRenderer, { document: comment.document.adf, dataProviders: dataProviders }));
    };
    ...
    Comment.prototype.renderEditor = function () {
        ...
        return (React.createElement(Editor_1.default, { isExpanded: true, onCancel: this.onCancelReply, onSave: this.onSaveReply, dataProviders: dataProviders, user: user, renderEditor: renderEditor, disableScrollTo: disableScrollTo, allowFeedbackAndHelpButtons: allowFeedbackAndHelpButtons }));
    };
    Comment.prototype.getActions = function () {
        ...
        if (createdBy && user && user.id === createdBy.id) {
            actions = actions.concat([
                React.createElement(comment_1.CommentAction, { key: "edit", onClick: this.onEdit }, "Edit"),
                React.createElement(comment_1.CommentAction, { key: "delete", onClick: this.onDelete }, "Delete"),
            ]);
        }
        if (containerId &&
            commentAri &&
            ...
            actions = actions.concat([
                React.createElement(editor_common_1.WithProviders, { key: "reactions", providers: ['emojiProvider', 'reactionsProvider'], providerFactory: dataProviders, renderNode: function (_a) {
                        var emojiProvider = _a.emojiProvider, reactionsProvider = _a.reactionsProvider;
                        return (React.createElement(Reactions, null,
                            React.createElement(reactions_1.ResourcedReactions, { containerAri: containerId, ari: commentAri, emojiProvider: emojiProvider, reactionsProvider: reactionsProvider })));
                    } }),
            ]);
        }
        return actions;
    ...
    Comment.prototype.render = function () {
        ...
        return (React.createElement(comment_1.default, { id: commentId, author: 
            // Render with onClick/href if they're supplied
            onUserClick || createdBy.profileUrl ? (React.createElement(comment_1.CommentAuthor, { onClick: this.handleUserClick(createdBy), href: createdBy.profileUrl || '#' }, createdBy && createdBy.name)) : (
            // Otherwise just render text
            React.createElement(comment_1.CommentAuthor, null, createdBy && createdBy.name)), avatar: React.createElement(avatar_1.default, { src: createdBy && createdBy.avatarUrl, href: createdBy && createdBy.profileUrl, name: createdBy && createdBy.name, enableTooltip: true }), time: React.createElement(comment_1.CommentTime, { onClick: this.handleTimeClick, href: disableScrollTo ? undefined : "#" + commentId }, distanceInWordsToNow(new Date(comment.createdAt), {
                addSuffix: true,
