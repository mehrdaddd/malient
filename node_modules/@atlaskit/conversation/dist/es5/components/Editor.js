...
var Editor = /** @class */ (function (_super) {
    ...
    function Editor(props) {
        ...
        _this.onSave = function (actions) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        value = _a.sent();
                        if (value && value.content.some(function (n) { return n.content && n.content.length; })) {
        ...
        _this.handleRef = function (node) {
            if (!_this.props.disableScrollTo && _this.props.isExpanded && node) {
        ...
        _this.renderEditor = function (actions) {
            ...
            var defaultProps = tslib_1.__assign({ appearance: 'comment', shouldFocus: true, allowCodeBlocks: true, allowLists: true, onSave: function () { return _this.onSave(actions); }, onCancel: _this.onCancel, defaultValue: defaultValue, allowHelpDialog: allowFeedbackAndHelpButtons, primaryToolbarComponents: allowFeedbackAndHelpButtons
                    ? [
                        React.createElement(editor_core_1.ToolbarFeedback, { key: "feedback", packageName: editor_core_1.name, packageVersion: editor_core_1.version }),
                        React.createElement(editor_core_1.ToolbarHelp, { key: "help" }),
                    ]
                    : undefined }, providers);
            return (React.createElement("div", { ref: _this.handleRef },
