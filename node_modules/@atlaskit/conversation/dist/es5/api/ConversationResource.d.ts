...
export interface ResourceProvider {
    ...
    create(localId: string, containerId: string, value: any, meta: any): Promise<Conversation>;
...
export declare class ConversationResource extends AbstractConversationResource {
    ...
    private makeRequest<T>(path, options?);
    /**
     * Retrieve the IDs (and meta-data) for all conversations associated with the container ID.
     */
    getConversations(containerId: string): Promise<Conversation[]>;
     ...
     */
    private createConversation(localId, containerId, value, meta, isMain?);
