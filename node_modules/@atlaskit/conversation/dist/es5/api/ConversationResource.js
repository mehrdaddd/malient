...
var store_1 = require("../internal/store");
...
var AbstractConversationResource = /** @class */ (function () {
    function AbstractConversationResource() {
        ...
        this._store = store_1.default(initialState);
    }
     ...
     */
    AbstractConversationResource.prototype.getConversations = function (containerId) {
     ...
     */
    AbstractConversationResource.prototype.create = function (localId, containerId, value, meta) {
        return Promise.reject('Not implemented');
    };
    /**
...
exports.AbstractConversationResource = AbstractConversationResource;
var ConversationResource = /** @class */ (function (_super) {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
                            throw new HttpError_1.HttpError(response.status, response.statusText);
                        }
                        // Content deleted
     ...
     * Retrieve the IDs (and meta-data) for all conversations associated with the container ID.
     */
    ConversationResource.prototype.getConversations = function (containerId) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var dispatch, values;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        dispatch({ type: actions_1.FETCH_CONVERSATIONS_REQUEST });
                        return [4 /*yield*/, this.makeRequest("/conversation?containerId=" + containerId + "&expand=comments.document.adf", {
                                method: 'GET',
                            })];
                    case 1:
                        values = (_a.sent()).values;
                        dispatch({ type: actions_1.FETCH_CONVERSATIONS_SUCCESS, payload: values });
     ...
     * Creates a new Conversation and associates it with the containerId provided.
     */
    ConversationResource.prototype.create = function (localId, containerId, value, meta) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        tempConversation = this.createConversation(localId, containerId, value, meta, isMain);
                        if (tempConversation) {
                            dispatch({
                                type: actions_1.CREATE_CONVERSATION_REQUEST,
                    ...
                    case 3:
                        ...
                        dispatch({ type: actions_1.CREATE_CONVERSATION_ERROR, payload: result });
                        return [2 /*return*/, result];
                    case 4:
                        dispatch({
                            type: actions_1.CREATE_CONVERSATION_SUCCESS,
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        dispatch({ type: actions_1.ADD_COMMENT_REQUEST, payload: tempComment });
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                    ...
                    case 3:
                        ...
                        dispatch({ type: actions_1.ADD_COMMENT_ERROR, payload: result_1 });
                        return [2 /*return*/, result_1];
                    case 4:
                        dispatch({
                            type: actions_1.ADD_COMMENT_SUCCESS,
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (tempComment) {
                            dispatch({
                                type: actions_1.UPDATE_COMMENT_REQUEST,
                    ...
                    case 3:
                        ...
                        dispatch({ type: actions_1.UPDATE_COMMENT_ERROR, payload: result_2 });
                        return [2 /*return*/, result_2];
                    case 4:
                        dispatch({ type: actions_1.UPDATE_COMMENT_SUCCESS, payload: result });
                        return [2 /*return*/, result];
                }
            });
        });
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        dispatch = this.dispatch;
                        dispatch({
                            type: actions_1.DELETE_COMMENT_REQUEST,
                    ...
                    case 3:
                        ...
                        dispatch({ type: actions_1.DELETE_COMMENT_ERROR, payload: result_3 });
                    ...
                    case 4:
                        ...
                        dispatch({ type: actions_1.DELETE_COMMENT_SUCCESS, payload: result });
                        return [2 /*return*/, result];
                }
            });
        });
    ...
    ConversationResource.prototype.revertComment = function (conversationId, commentId) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                dispatch({ type: actions_1.REVERT_COMMENT, payload: comment });
    ...
    ConversationResource.prototype.updateUser = function (user) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                dispatch = this.dispatch;
                dispatch({ type: actions_1.UPDATE_USER_SUCCESS, payload: { user: user } });
     ...
     */
    ConversationResource.prototype.createConversation = function (localId, containerId, value, meta, isMain) {
        return {
            localId: localId,
            containerId: containerId,
            meta: meta,
    ...
    ConversationResource.prototype.createComment = function (conversationId, parentId, doc, localId) {
        if (localId === void 0) { localId = uuid_1.uuid.generate(); }
        return {
            createdBy: this.config.user,
            createdAt: Date.now(),
            commentId: uuid_1.uuid.generate(),
            document: {
                adf: doc,
            },
            conversationId: conversationId,
    ...
    ConversationResource.prototype.getComment = function (conversationId, commentId) {
        ...
        var conversation = state.conversations.filter(function (c) { return c.conversationId === conversationId; })[0];
        if (!conversation) {
            return undefined;
        }
        var comment = (conversation.comments || []).filter(function (c) { return c.commentId === commentId; })[0];
