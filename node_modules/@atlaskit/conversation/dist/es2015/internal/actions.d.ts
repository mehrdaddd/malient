...
export declare const addComment: (conversationId: string, parentId: string, value: any, localId: string | undefined, provider: ResourceProvider) => () => Promise<void>;
export declare const updateComment: (conversationId: string, commentId: string, value: any, provider: ResourceProvider) => () => Promise<void>;
export declare const deleteComment: (conversationId: string, commentId: string, provider: ResourceProvider) => () => Promise<void>;
...
export declare const createConversation: (localId: string, containerId: string, value: any, meta: any, provider: ResourceProvider) => () => Promise<void>;
