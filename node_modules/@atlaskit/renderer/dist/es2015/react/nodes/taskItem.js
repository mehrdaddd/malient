...
var TaskItem = /** @class */ (function (_super) {
    ...
    function TaskItem(props) {
        ...
        _this.renderWithProvider = function (providers) {
            ...
            return (React.createElement(TaskItemWithProviders, { objectAri: objectAri, containerAri: containerAri, taskId: localId, isDone: state === 'DONE', taskDecisionProvider: taskDecisionProvider, contextIdentifierProvider: contextIdentifierProvider }, children));
        };
