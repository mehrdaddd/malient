...
var MediaGroup = /** @class */ (function (_super) {
    ...
    MediaGroup.prototype.renderStrip = function () {
        ...
        return (React.createElement(FilmstripView, { animate: animate, offset: offset, onSize: this.handleSize, onScroll: this.handleScroll }, React.Children.map(children, function (child) {
