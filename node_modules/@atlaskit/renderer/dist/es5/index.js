...
exports.BreakoutProvider = react_1.BreakoutProvider;
var text_1 = require("./text");
exports.TextSerializer = text_1.default;
var email_1 = require("./email");
exports.EmailSerializer = email_1.default;
var Renderer_1 = require("./ui/Renderer");
exports.ReactRenderer = Renderer_1.default;
var utils_1 = require("./utils");
exports.ADFEncoder = utils_1.ADFEncoder;
...
exports.renderDocument = function (doc, serializer, schema, adfStage) {
    ...
    var _a = withStopwatch(function () {
        return editor_common_1.getValidDocument(doc, schema, adfStage);
...
exports.renderNodes = function (nodes, serializer, schema, target, adfStage) {
    if (schema === void 0) { schema = editor_common_1.defaultSchema; }
    if (adfStage === void 0) { adfStage = 'final'; }
    var validNodes = nodes.map(function (n) { return editor_common_1.getValidNode(n, schema, adfStage); });
