...
var MediaGroup = /** @class */ (function (_super) {
    ...
    MediaGroup.prototype.cloneFileCard = function (child, surroundingItems) {
        ...
        return React.cloneElement(child, {
            ...
            eventHandlers: tslib_1.__assign({}, child.props.eventHandlers, { media: {
                    onClick: function (event, analyticsEvent) {
                        if (!_this.props ||
                            !_this.props.eventHandlers ||
                            !_this.props.eventHandlers.media ||
                            !_this.props.eventHandlers.media.onClick) {
                            return;
                        }
                        var surroundings = {
                        ...
                        _this.props.eventHandlers.media.onClick(event, surroundings, analyticsEvent);
                    },
                } }),
        });
    };
    MediaGroup.prototype.renderStrip = function () {
        ...
        return (React.createElement(media_filmstrip_1.FilmstripView, { animate: animate, offset: offset, onSize: this.handleSize, onScroll: this.handleScroll }, React.Children.map(children, function (child) {
