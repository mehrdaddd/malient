...
export declare const MediaCard: new (props: MediaCardProps & ImageLoaderProps, context?: any) => {
    ...
    onError: () => void;
    render(): JSX.Element;
    setState<K extends "imageStatus">(state: ImageLoaderState | Pick<ImageLoaderState, K> | ((prevState: Readonly<ImageLoaderState>, props: MediaCardProps & ImageLoaderProps) => ImageLoaderState | Pick<ImageLoaderState, K> | null) | null, callback?: (() => void) | undefined): void;
