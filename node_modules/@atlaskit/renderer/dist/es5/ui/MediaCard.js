...
var MediaCardInternal = /** @class */ (function (_super) {
    ...
    MediaCardInternal.prototype.renderExternal = function () {
        ...
        return (React.createElement(media_card_1.CardView, { status: imageStatus || 'loading', dataURI: url, dimensions: cardDimensions, metadata: {
                mediaType: 'image',
                name: url,
    ...
    MediaCardInternal.prototype.render = function () {
        ...
        if (!context) {
            return (React.createElement(media_card_1.CardView, { status: "loading", mediaItemType: type, dimensions: cardDimensions }));
        }
        var identifier = {
            id: id,
            mediaItemType: type,
        ...
        return (React.createElement(media_card_1.Card, { identifier: identifier, context: context, dimensions: cardDimensions, onClick: eventHandlers && eventHandlers.media && eventHandlers.media.onClick, resizeMode: resizeMode, appearance: appearance, disableOverlay: disableOverlay }));
    };
