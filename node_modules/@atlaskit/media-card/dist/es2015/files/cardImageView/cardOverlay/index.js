...
var CardOverlay = /** @class */ (function (_super) {
    ...
    Object.defineProperty(CardOverlay.prototype, "wrapperClassNames", {
        get: function () {
            var _a = this.props, error = _a.error, selectable = _a.selectable, selected = _a.selected, mediaType = _a.mediaType, persistent = _a.persistent;
    ...
    CardOverlay.prototype.render = function () {
        var _a = this.props, error = _a.error, mediaName = _a.mediaName, persistent = _a.persistent, actions = _a.actions;
        var titleText = error || !mediaName ? '' : mediaName;
        var menuTriggerColor = !persistent ? 'white' : undefined;
        return (React.createElement(Overlay, { hasError: !!error, className: this.wrapperClassNames },
    ...
    CardOverlay.prototype.bottomLeftColumn = function () {
        ...
        if (error) {
            ...
            return (React.createElement(ErrorWrapper, null,
                ...
                React.createElement(Retry, { onClick: onRetry }, "Retry")));
        }
        else {
