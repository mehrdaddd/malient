...
import { Actions, ActionsMenu, ActionButtonWrapper, FailureMessageBlock, FailureMessage, SuccessMessage, ButtonWrapper, } from '../styled/ActionsView';
import Spinner from '@atlaskit/spinner';
import Button from '@atlaskit/button';
export var UntypedButton = Button;
export var TRY_AGAIN_LINK_TEXT = 'Try again';
var ActionsView = /** @class */ (function (_super) {
    ...
    ActionsView.prototype.createCallbackHandlers = function (actionType) {
        ...
        return {
            ...
            failure: function (message, tryAgain, tryAgainLinkText) {
                ...
                if (tryAgainLinkText === void 0) { tryAgainLinkText = TRY_AGAIN_LINK_TEXT; }
                return _this.updateProgressState({
                    actionInProgress: null,
    ...
    ActionsView.prototype.getActionButton = function (action) {
        if (action) {
            ...
            var spinner = isCurrentActionInProgress ? (React.createElement(Spinner, { size: "small", invertColor: isInversed })) : null;
            var content = isCurrentActionInProgress
                ? null
                : action.appCardAction.title;
            return (React.createElement(ActionButtonWrapper, null,
                React.createElement(ButtonWrapper, { isDark: isInversed },
                    React.createElement(UntypedButton, { isDisabled: this.isInProgress, onClick: this.handleActionButton(action), theme: this.theme, iconAfter: spinner }, content))));
        }
        return null;
    };
    ActionsView.prototype.getMeatballsButton = function () {
        var isInversed = this.props.isInversed;
        var icon = this.isOtherActionInProgress ? (React.createElement(Spinner, { size: "small", invertColor: isInversed })) : (React.createElement(MeatballIcon, { label: "actions", size: "medium" }));
        return (React.createElement(ButtonWrapper, { isDark: isInversed },
            React.createElement(UntypedButton, { isDisabled: this.isInProgress, appearance: "subtle", iconBefore: icon, theme: this.theme })));
    };
    ActionsView.prototype.getDropdown = function () {
        ...
        return (React.createElement(ActionsMenu, { onClick: this.handleMeatballsClick },
    ...
    ActionsView.prototype.render = function () {
        ...
        if (failureMessage !== null) {
            return (React.createElement(FailureMessageBlock, null,
                React.createElement(FailureMessage, { tryAgain: tryAgain }, failureMessage),
                tryAgain ? (React.createElement(UntypedButton, { appearance: "link", onClick: this.handleTryAgain, theme: this.theme }, tryAgainLinkText)) : null));
        }
        if (successMessage !== null) {
            return React.createElement(SuccessMessage, null, successMessage);
        }
