...
exports.Ellipsify = function (props) {
    return (React.createElement(Wrapper, { className: "ellipsed-text", innerRef: setEllipsis(props), "aria-label": props.text, inline: props.inline }, props.text));
};
...
var timeout = function (fn) { return window.setTimeout(fn, 1); };
var delayRun = window.requestAnimationFrame || timeout;
exports.default = exports.Ellipsify;
