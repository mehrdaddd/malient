...
exports.cardTitle = "\n  color: " + util_shared_styles_1.akColorN900 + ";\n  font-size: 16px;\n  font-weight: 500;\n  line-height: " + 20 / 16 + ";\n";
exports.cardDescription = "\n  color: " + util_shared_styles_1.akColorN300 + ";\n  font-size: 12px;\n  line-height: " + 16 / 12 + ";\n";
...
exports.borderRadius = "\n  border-radius: " + util_shared_styles_1.akBorderRadius + ";\n";
exports.borderRadiusBottom = "\n  border-bottom-left-radius: " + util_shared_styles_1.akBorderRadius + ";\n  border-bottom-right-radius: " + util_shared_styles_1.akBorderRadius + ";\n";
