...
var EditorActions = /** @class */ (function () {
    ...
    EditorActions.prototype.getValue = function () {
        var _this = this;
        return utils_1.getEditorValueWithMedia(this.editorView).then(function (doc) {
            var processedDoc = utils_1.preprocessDoc(_this.editorView.state.schema, doc);
            if (_this.contentTransformer && processedDoc) {
                return _this.contentTransformer.encode(processedDoc);
            }
            return processedDoc ? utils_1.toJSON(processedDoc) : processedDoc;
        });
    };
