...
import { Transformer, ContextIdentifierProvider, ExtensionHandlers } from '@atlaskit/editor-common';
...
export declare type EditorAppearance = 'message' | 'inline-comment' | 'comment' | 'full-page' | 'chromeless' | 'mobile' | undefined;
export declare type ReactElement = React.ReactElement<any> | React.ReactElement<any>[];
