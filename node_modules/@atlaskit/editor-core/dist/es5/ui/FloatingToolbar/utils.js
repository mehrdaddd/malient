...
exports.getOffsetParent = function (editorViewDom, popupsMountPoint) {
    return popupsMountPoint
        ? popupsMountPoint.offsetParent
        : editorViewDom.offsetParent;
};
exports.getNearestNonTextNode = function (node) {
...
exports.handlePositionCalculatedWith = function (offsetParent, node, getCurrentFixedCoordinates) { return function (position) {
    if (!offsetParent) {
        return position;
    }
    var target = exports.getNearestNonTextNode(node);
