...
var ClickAreaBlock = /** @class */ (function (_super) {
    ...
    function ClickAreaBlock() {
        ...
        _this.handleClick = function (event) {
            ...
            var contentArea = event.currentTarget.querySelector('.content-area');
            ...
            if ((!contentArea || !insideContentArea(event.target.parentNode)) &&
                ...
                var isParagrpahAppended = bottomAreaClicked
                    ...
                    : false;
                var isGapCursorSet = gap_cursor_1.setGapCursorForTopLevelBlocks(event, dom, view.posAtCoords.bind(view))(view.state, dispatch);
