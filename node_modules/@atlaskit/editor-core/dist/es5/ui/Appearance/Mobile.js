...
var main_1 = require("../../plugins/mentions/pm-plugins/main");
...
var Editor = /** @class */ (function (_super) {
    ...
    function Editor() {
        ...
        _this.renderMobile = function (_a) {
            ...
            return (React.createElement(MobileEditor, { className: _this.flashToggle ? '-flash' : '', isMaxContentSizeReached: maxContentSizeReached, maxHeight: maxHeight },
                React.createElement(ContentArea, { innerRef: _this.handleRef },
                    customContentComponents,
                    React.createElement(PluginSlot_1.default, { editorView: editorView, eventDispatcher: eventDispatcher, providerFactory: providerFactory, appearance: _this.appearance, disabled: !!disabled }),
                    editorDOMElement)));
        };
        return _this;
    }
    Editor.prototype.render = function () {
        ...
        return (React.createElement(WithPluginState_1.default, { editorView: editorView, eventDispatcher: eventDispatcher, plugins: {
                ...
                mentions: main_1.mentionPluginKey,
