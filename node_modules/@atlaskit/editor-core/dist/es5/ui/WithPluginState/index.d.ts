...
export default class WithPluginState extends React.Component<Props, State> {
    ...
    private getEditorView(maybeProps?, maybeContext?);
    private getEventDispatcher(maybeProps?);
    private handlePluginStateChange;
    /**
     * Debounces setState calls in order to reduce number of re-renders caused by several plugin state changes.
     */
    private updateState(stateSubset);
    private getPluginsStates(plugins, editorView?);
    private subscribe(props);
    private unsubscribe();
    private onContextUpdate;
    private subscribeToContextUpdates(context?);
    private unsubscribeFromContextUpdates(context?);
