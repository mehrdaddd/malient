 ...
 */
export declare function closestElement(node: HTMLElement | null, s: string): HTMLElement | null;
...
export declare const isEmptyNode: (schema: Schema) => (node: Node) => any;
export declare const isTableCell: (state: EditorState) => boolean;
