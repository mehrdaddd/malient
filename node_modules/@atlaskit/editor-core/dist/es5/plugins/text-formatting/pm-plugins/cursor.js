    ...
    props: {
        handleClick: function (view, clickPos, event) {
            ...
            var clickWasAtEdgeOfATextNode = ($click.nodeBefore ? $click.nodeBefore.isInline : $click.nodeAfter) &&
                ...
                $click.textOffset === 0;
            var clickWasNearACodeMark = ($click.nodeBefore && code.isInSet($click.nodeBefore.marks)) ||
            ...
            if (clickWasAtEdgeOfATextNode &&
                ...
                var tr = view.state.tr.setSelection(prosemirror_state_1.TextSelection.near($click));
