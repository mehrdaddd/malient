...
var ClearFormattingState = /** @class */ (function () {
    ...
    ClearFormattingState.prototype.update = function (newEditorState) {
        ...
        this.activeMarkTypes = clear_formatting_1.FORMATTING_MARK_TYPES.filter(function (mark) {
    ...
    ClearFormattingState.prototype.clearFormatting = function (view) {
        clear_formatting_1.clearFormatting()(view.state, view.dispatch);
    };
...
exports.stateKey = new prosemirror_state_1.PluginKey('clearFormattingPlugin');
