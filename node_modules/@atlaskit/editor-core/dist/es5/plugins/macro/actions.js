...
exports.insertMacroFromMacroBrowser = function (macroProvider, macroNode) { return function (view) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var newMacro, node, bodiedExtension, tr;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                newMacro = _a.sent();
                if (newMacro) {
                    node = exports.resolveMacro(newMacro, view.state);
                    bodiedExtension = view.state.schema.nodes.bodiedExtension;
                    tr = view.state.tr;
                    if (node) {
                        if (
                        ...
                        tr.selection instanceof prosemirror_state_1.NodeSelection &&
                            ...
                            !prosemirror_utils_1.hasParentNodeOfType(bodiedExtension)(tr.selection)) {
...
exports.resolveMacro = function (macro, state) {
    if (!macro || !state) {
        return null;
    }
    ...
    if (type === 'extension') {
        ...
        node = schema.nodes.bodiedExtension.create(attrs, schema.nodeFromJSON(macro).content);
    }
