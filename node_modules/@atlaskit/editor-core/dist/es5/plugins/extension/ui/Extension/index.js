...
var Extension = /** @class */ (function (_super) {
    ...
    function Extension(props) {
        ...
        _this.renderWithProvider = function (providers) {
            ...
            return (React.createElement(ExtensionComponent_1.default, { editorView: editorView, node: node, macroProvider: macroProvider, setExtensionElement: actions_1.setExtensionElement, handleContentDOMRef: handleContentDOMRef, extensionHandlers: extensionHandlers }));
        };
