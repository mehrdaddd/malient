...
exports.createHorizontalRule = function (state, start, end) {
    ...
    return state.tr.replaceWith(start, end, prosemirror_model_1.Fragment.from(state.schema.nodes.rule.create()));
};
...
function inputRulePlugin(schema) {
    ...
    if (schema.nodes.rule) {
        ...
        rules.push(input_rules_1.createInputRule(new RegExp(input_rules_1.leafNodeReplacementCharacter + "\\-\\-\\-|" + input_rules_1.leafNodeReplacementCharacter + "\\*\\*\\*"), function (state, match, start, end) {
