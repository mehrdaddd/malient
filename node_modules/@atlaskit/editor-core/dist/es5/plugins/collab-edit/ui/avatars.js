    ...
    function Avatars() {
        ...
        _this.renderAvatars = function (state) {
            ...
            return (React.createElement(AvatarContainer, null,
                React.createElement(avatar_1.AvatarGroup, { appearance: "stack", size: "medium", data: avatars, onAvatarClick: _this.onAvatarClick, avatar: Item }),
