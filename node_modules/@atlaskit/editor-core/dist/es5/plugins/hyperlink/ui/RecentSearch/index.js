...
var RecentSearch = /** @class */ (function (_super) {
    ...
    RecentSearch.prototype.render = function () {
        ...
        return (React.createElement(Container, null,
            React.createElement(PanelTextInput_1.default, { placeholder: "Paste link or search recently viewed", autoFocus: true, onSubmit: this.handleSubmit, onChange: this.updateInput, onBlur: this.handleBlur, onCancel: this.handleBlur, onKeyDown: this.handleKeyDown }),
    ...
    RecentSearch.prototype.trackAutoCompleteAnalyticsEvent = function (name) {
        var numChars = this.state.input ? this.state.input.length : 0;
