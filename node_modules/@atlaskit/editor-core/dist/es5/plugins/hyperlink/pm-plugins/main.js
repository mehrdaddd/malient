...
exports.hyperlinkPluginKey = new prosemirror_state_1.PluginKey('hyperlinkPlugin');
var HyperlinkState = /** @class */ (function () {
    ...
    HyperlinkState.prototype.addLink = function (options, view) {
        if (this.linkable && !this.active) {
            ...
            var mark = state.schema.mark('link', { href: utils_2.normalizeUrl(href) });
            var tr = empty
    ...
    HyperlinkState.prototype.updateLink = function (options, view) {
        if (this.activeLinkStartPos) {
            ...
            view.dispatch(state.tr
                ...
                .addMark(from, to, state.schema.mark('link', { href: utils_2.normalizeUrl(options.href) })));
        }
    };
    ...
    HyperlinkState.prototype.hideLinkPanel = function (state, dispatch) {
        ...
        cursor_1.removeFakeTextCursor(state, dispatch);
    };
    ...
    HyperlinkState.prototype.isActiveNodeLinkable = function () {
        ...
        return !!link && utils_1.isMarkTypeAllowedInCurrentSelection(link, this.state);
    };
    return HyperlinkState;
}());
exports.HyperlinkState = HyperlinkState;
function isReplaceStep(step) {
    return !!step && step instanceof prosemirror_transform_1.ReplaceStep;
}
    ...
    if (transactions.some(function (tr) { return tr.steps.some(isReplaceStep); })) {
        ...
        if (oldNodeAfter &&
            ...
            oldLinkMarkBefore.attrs.href ===
                utils_2.normalizeUrl("" + oldNodeBefore.text + oldNodeAfter.text)) {
        ...
        oldLinkMarkBefore.attrs.href === utils_2.normalizeUrl(oldNodeBefore.text || '') &&
        ...
        var match = utils_2.getLinkMatch(href);
...
exports.createPlugin = function (schema, editorProps) {
    if (editorProps === void 0) { editorProps = {}; }
    return new prosemirror_state_1.Plugin({
        props: {
            handleTextInput: function (view, from, to, text) {
                var pluginState = exports.hyperlinkPluginKey.getState(view.state);
        ...
        key: exports.hyperlinkPluginKey,
        view: function (view) {
            var pluginState = exports.hyperlinkPluginKey.getState(view.state);
