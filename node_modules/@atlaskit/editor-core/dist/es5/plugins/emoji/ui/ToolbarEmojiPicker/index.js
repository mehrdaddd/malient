...
var ToolbarEmojiPicker = /** @class */ (function (_super) {
    ...
    ToolbarEmojiPicker.prototype.render = function () {
        ...
        var toolbarButton = (React.createElement(ToolbarButton_1.default, { selected: isOpen, disabled: disabled || isDisabled, onClick: this.toggleOpen, iconBefore: React.createElement(emoji_1.default, { label: "Insert emoji (:)" }), ref: this.handleButtonRef, title: "Insert emoji (:)", hideTooltip: isOpen, spacing: isReducedSpacing ? 'none' : 'default' }));
