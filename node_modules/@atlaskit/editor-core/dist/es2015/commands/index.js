...
import { isRangeOfType, canMoveDown, canMoveUp, atTheEndOfDoc, atTheBeginningOfBlock, isTableCell, } from '../utils';
import { hyperlinkPluginKey } from '../plugins/hyperlink';
export function setBlockType(view, name) {
...
export function showLinkPanel() {
    return function (state, dispatch, view) {
        var pluginState = hyperlinkPluginKey.getState(state);
...
export function shouldAppendParagraphAfterBlockNode(state) {
    return ((atTheEndOfDoc(state) && atTheBeginningOfBlock(state)) || isTableCell(state));
}
export function insertNodesEndWithNewParagraph(nodes) {
    return function (state, dispatch) {
...
export function createNewParagraphAbove(state, dispatch) {
    var append = false;
...
export function createNewParagraphBelow(state, dispatch) {
    var append = true;
...
export var removeEmptyHeadingAtStartOfDocument = function (state, dispatch) {
