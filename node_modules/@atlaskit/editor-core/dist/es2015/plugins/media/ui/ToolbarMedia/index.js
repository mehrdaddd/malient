...
var ToolbarMedia = /** @class */ (function (_super) {
    ...
    ToolbarMedia.prototype.render = function () {
        ...
        return (React.createElement(ToolbarButton, { onClick: this.handleClickMediaButton, disabled: isDisabled, title: "Insert files and images", spacing: isReducedSpacing ? 'none' : 'default', iconBefore: React.createElement(AttachmentIcon, { label: "Insert files and images" }) }));
    };
