...
import { GapCursorSelection, JSON_ID } from '../selection';
...
export var isButton = function (elem) {
    var tableControls = document.querySelector('.table-column-controls-wrapper');
    return (elem &&
    ...
    props: {
        decorations: function (_a) {
            ...
            if (selection instanceof GapCursorSelection) {
                ...
                node.className = "ProseMirror-gapcursor " + (side === 1 /* LEFT */ ? '-left' : '-right');
                ...
                if (side === 0 /* RIGHT */ && $from.nodeBefore) {
        ...
        handleClick: function (view, position, event) {
            ...
            if (posAtCoords &&
                ...
                var side = event.offsetX > leftSideOffsetX ? 0 /* RIGHT */ : 1 /* LEFT */;
