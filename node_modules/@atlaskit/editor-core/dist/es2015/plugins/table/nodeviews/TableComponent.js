...
import { hoverColumns, hoverTable, hoverRows, resetHoverSelection, insertColumn, insertRow, } from '../actions';
...
var TableComponent = /** @class */ (function (_super) {
    ...
    TableComponent.prototype.componentDidMount = function () {
        if (this.props.allowColumnResizing) {
            if (this.colgroup && this.table) {
                updateColumnsOnResize(this.props.node, this.colgroup, this.table, this.props.cellMinWidth || DEFAULT_CELL_MIN_WIDTH);
            }
    ...
    TableComponent.prototype.render = function () {
        ...
        var _b = hoverSelectionPluginKey.getState(view.state), isTableHovered = _b.isTableHovered, isTableInDanger = _b.isTableInDanger;
        return (React.createElement(WithPluginState, { plugins: {
                ...
                return (React.createElement("div", { style: {
                    ...
                    React.createElement("div", { className: "table-row-controls-wrapper" },
                        React.createElement(TableFloatingControls, { editorView: view, tableElement: pluginState.tableElement, isTableHovered: isTableHovered, hoverTable: hoverTable, hoverRows: hoverRows, resetHoverSelection: resetHoverSelection, insertColumn: insertColumn, insertRow: insertRow, remove: pluginState.remove, isTableInDanger: isTableInDanger })),
                    React.createElement("div", { className: "table-wrapper", ref: function (elem) {
                        ...
                        React.createElement("div", { className: "table-column-controls-wrapper" },
                            React.createElement(ColumnControls, { editorView: view, tableElement: pluginState.tableElement, isTableHovered: isTableHovered, insertColumn: insertColumn, remove: pluginState.remove, hoverColumns: hoverColumns, resetHoverSelection: resetHoverSelection, isTableInDanger: isTableInDanger })),
    ...
    TableComponent.prototype.componentDidUpdate = function () {
        ...
        if (allowColumnResizing && this.colgroup && this.table) {
            updateColumnsOnResize(node, this.colgroup, this.table, cellMinWidth || DEFAULT_CELL_MIN_WIDTH);
        }
    };
