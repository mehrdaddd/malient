...
var ToolbarEmojiPicker = /** @class */ (function (_super) {
    ...
    ToolbarEmojiPicker.prototype.render = function () {
        ...
        var toolbarButton = (React.createElement(ToolbarButton, { selected: isOpen, disabled: disabled || isDisabled, onClick: this.toggleOpen, iconBefore: React.createElement(EmojiIcon, { label: "Insert emoji (:)" }), ref: this.handleButtonRef, title: "Insert emoji (:)", hideTooltip: isOpen, spacing: isReducedSpacing ? 'none' : 'default' }));
