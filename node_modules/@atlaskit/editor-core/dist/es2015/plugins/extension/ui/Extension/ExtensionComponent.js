    ...
    ExtensionComponent.prototype.render = function () {
        ...
        switch (node.type.name) {
            ...
            case 'bodiedExtension':
                return (React.createElement(Extension, { node: node, macroProvider: macroProvider, onClick: this.handleClick, handleContentDOMRef: handleContentDOMRef, onSelectExtension: this.handleSelectExtension }, extensionHandlerResult));
            case 'inlineExtension':
                return (React.createElement(InlineExtension, { node: node, macroProvider: macroProvider, onClick: this.handleClick }, extensionHandlerResult));
            default:
                return null;
        }
    };
