...
var Extension = /** @class */ (function (_super) {
    ...
    function Extension(props) {
        ...
        _this.renderWithProvider = function (providers) {
            ...
            return (React.createElement(ExtensionComponent, { editorView: editorView, node: node, macroProvider: macroProvider, setExtensionElement: setExtensionElement, handleContentDOMRef: handleContentDOMRef, extensionHandlers: extensionHandlers }));
        };
