...
var FileCardImageView = /** @class */ (function (_super) {
    ...
    function FileCardImageView() {
        ...
        _this.getUploadingContents = function () {
            ...
            return (React.createElement("div", { className: "wrapper" },
                React.createElement("div", { className: "img-wrapper" },
                    React.createElement(UploadingView, { title: mediaName, progress: progress || 0, dataURI: dataURI, actions: actions })),
                overlay));
        };
        ...
        _this.getSuccessCardContents = function () {
            ...
            return (React.createElement("div", { className: "wrapper" },
                React.createElement("div", { className: "img-wrapper" },
                    React.createElement(CardContent, { loading: _this.isDownloadingOrProcessing(), mediaItemType: "file", mediaType: mediaType, dataURI: dataURI, crop: _this.isCropped })),
                overlay));
        };
    ...
    FileCardImageView.prototype.render = function () {
        ...
        return (React.createElement(Wrapper, { disableOverlay: disableOverlay, selectable: selectable, selected: selected }, this.getCardContents()));
    };
