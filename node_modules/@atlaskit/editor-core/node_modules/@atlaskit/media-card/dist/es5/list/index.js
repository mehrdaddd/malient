...
var LoadingComponent = (React.createElement(styled_1.Spinner, { className: "spinner", style: { width: '100%', height: '100%' } }, "loading..."));
...
var CardList = /** @class */ (function (_super) {
    ...
    CardList.prototype.render = function () {
        ...
        if (error) {
            if (media_core_1.isCollectionNotFoundError(error)) {
        ...
        if (this.useInfiniteScroll) {
            return (React.createElement(infiniteScroll_1.InfiniteScroll, { height: height, onThresholdReached: this.handleInfiniteScrollThresholdReached }, this.renderList()));
        }
    ...
    CardList.prototype.renderList = function () {
        ...
        var cards = collection
            ? collection.items.filter(function (item) { return item.type === 'file'; }).map(function (mediaItem) {
                ...
                var cardListItem = (React.createElement(react_transition_group_1.CSSTransition, { key: key, classNames: "card-list-item", timeout: { enter: 750 }, exit: false, component: "div", className: "card-list" },
                    React.createElement(styled_1.CardListItemWrapper, { shouldAnimate: shouldAnimate, cardWidth: cardWidth },
                        React.createElement(root_1.MediaCard, { provider: providersByMediaItemId[mediaItem.details.id], dataURIService: dataURIService, appearance: cardAppearance, dimensions: dimensions, onClick: handleCardClick.bind(_this, mediaItem), actions: cardActions(mediaItem) }))));
                ...
                return useLazyContent ? (React.createElement(lazyContent_1.LazyContent, { key: key, placeholder: placeholder }, cardListItem)) : (cardListItem);
            })
            : null;
        return React.createElement(react_transition_group_1.TransitionGroup, null, cards);
    };
    ...
    Object.defineProperty(CardList.prototype, "cardWidth", {
        ...
        get: function () {
            ...
            if (cardAppearance === 'image') {
                return utils_1.defaultImageCardDimensions.width;
            }
    ...
    Object.defineProperty(CardList.prototype, "cardHeight", {
        get: function () {
            ...
            if (cardAppearance === 'image') {
                return utils_1.defaultImageCardDimensions.height;
            }
            if (cardAppearance === 'small') {
                return utils_1.defaultSmallCardDimensions.height;
            }
        },
        enumerable: true,
        configurable: true
    ...
    Object.defineProperty(CardList.prototype, "placeholder", {
        get: function () {
            ...
            return (React.createElement(styled_1.CardListItemWrapper, { cardWidth: cardWidth },
                React.createElement(root_1.CardView, { dimensions: dimensions, status: "loading", appearance: cardAppearance })));
        },
        enumerable: true,
        configurable: true
    });
