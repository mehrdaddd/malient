...
var getCSSUnitValue_1 = require("./getCSSUnitValue");
// Default dimensions
...
exports.getCardMinHeight = function (appearance) {
    if (appearance === 'small') {
        return exports.minSmallCardDimensions.height;
    }
    if (appearance === 'image') {
        return exports.minImageCardDimensions.height;
    }
    if (appearance === 'horizontal') {
        return exports.minHorizontalCardDimensions.height;
    }
    if (appearance === 'square') {
        return exports.minSquareCardDimensions.height;
    }
    return exports.minSmallCardDimensions.height;
};
...
exports.getCSSBoundaries = function (appearance) {
    var width = "\n    min-width: " + getCSSUnitValue_1.getCSSUnitValue(exports.getCardMinWidth(appearance)) + ";\n    max-width: " + getCSSUnitValue_1.getCSSUnitValue(exports.getCardMaxWidth(appearance)) + ";\n  ";
    var height = '';
    if (appearance === 'horizontal') {
        height = "\n      height: " + getCSSUnitValue_1.getCSSUnitValue(exports.defaultHorizontalCardDimensions.height || '') + ";\n    ";
    }
    return width + height;
};
exports.getDefaultCardDimensions = function (appearance) {
    if (appearance === 'small') {
        return exports.defaultSmallCardDimensions;
    }
    if (appearance === 'image') {
