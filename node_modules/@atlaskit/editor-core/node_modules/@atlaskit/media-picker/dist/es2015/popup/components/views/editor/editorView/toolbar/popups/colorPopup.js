...
var ColorPopup = /** @class */ (function (_super) {
    ...
    ColorPopup.prototype.render = function () {
        return React.createElement(ColorPopupContainer, null, this.renderButtons());
    };
    ColorPopup.prototype.renderButtons = function () {
        var _a = this.props, onPickColor = _a.onPickColor, currentColor = _a.color;
        return colors.map(function (color, index) { return (React.createElement(ColorButton, { key: "" + index, color: color, currentColor: currentColor, onClick: onPickColor })); });
    };
    return ColorPopup;
}(Component));
export { ColorPopup };
