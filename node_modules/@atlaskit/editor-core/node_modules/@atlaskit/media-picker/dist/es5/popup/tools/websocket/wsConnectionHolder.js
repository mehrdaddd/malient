...
var wsConnection_1 = require("./wsConnection");
...
var WsConnectionHolder = /** @class */ (function () {
    function WsConnectionHolder(apiUrl, auth) {
        var _this = this;
        this.apiUrl = apiUrl;
        this.auth = auth;
        this.activities = [];
    ...
    WsConnectionHolder.prototype.openConnection = function (activity) {
        ...
        if (!this.wsConnection) {
            this.wsConnection = new wsConnection_1.WsConnection(this.apiUrl, this.auth, this.onWebSocketDataReceived, this.onConnectionLost);
        }
    };
...
exports.WsConnectionHolder = WsConnectionHolder;
