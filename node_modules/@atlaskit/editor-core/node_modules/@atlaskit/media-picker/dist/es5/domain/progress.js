...
var SmartMediaProgress = /** @class */ (function () {
    function SmartMediaProgress(size, progress, startTime, measureTime) {
        ...
        if (!SmartMediaProgress.isValidProgress(size, progress)) {
            handleError_1.handleError('wrong_progress', 'The progress format is incorrect.');
            return;
        }
        if (!SmartMediaProgress.isValidStartTime(startTime)) {
            handleError_1.handleError('wrong_start_time', 'The progress start time has incorrect format.');
            return;
        }
        if (!SmartMediaProgress.isValidMeasureTime(startTime, measureTime)) {
            handleError_1.handleError('wrong_measure_time', 'The progress measure time has incorrect format.');
            return;
        }
        this.size = size;
        this.progress = progress;
...
exports.SmartMediaProgress = SmartMediaProgress;
