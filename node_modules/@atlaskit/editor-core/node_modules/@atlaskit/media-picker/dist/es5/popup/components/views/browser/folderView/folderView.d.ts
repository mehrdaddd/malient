...
import { Path, SelectedItem, ServiceAccountLink, ServiceAccountWithType, ServiceFile, ServiceFolderItem, ServiceName } from '../../../../domain';
...
export declare class FolderViewer extends Component<FolderViewerProps, {}> {
    ...
    private renderFolderContent(items);
