...
var objectToQueryString_1 = require("../objectToQueryString");
// Helper function that formats websocket URL based on API URL
exports.getWsUrl = function (apiUrl) {
...
var Ws = /** @class */ (function () {
    function Ws(apiUrl, auth, onDataReceived, onConnectionLost) {
        var _this = this;
        ...
        var wsUrl = exports.getWsUrl(apiUrl);
        ...
        this.ws = new WebSocket(wsUrl + "?" + objectToQueryString_1.objectToQueryString(authParams));
        this.setHandler();
        this.schedulePing();
    }
    return Ws;
