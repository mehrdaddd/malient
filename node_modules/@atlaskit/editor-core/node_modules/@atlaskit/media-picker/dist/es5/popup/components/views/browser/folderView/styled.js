...
exports.FolderViewerRow = styled_components_1.default.li(templateObject_4 || (templateObject_4 = tslib_1.__makeTemplateObject(["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n\n  width: 100%;\n  height: 48px;\n\n  margin-top: 0;\n  padding: 8px 28px 8px 28px;\n\n  cursor: pointer;\n\n  ", " &:hover {\n    ", ";\n  }\n"], ["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n\n  width: 100%;\n  height: 48px;\n\n  margin-top: 0;\n  padding: 8px 28px 8px 28px;\n\n  cursor: pointer;\n\n  ",
    ...
    return isSelected
        ? "background-color: " + util_shared_styles_1.akColorB200 + ";"
        : 'background-color: white;';
}, function (_a) {
    var isSelected = _a.isSelected;
    return isSelected
        ? "background-color: " + util_shared_styles_1.akColorB200 + ";"
        : "background-color: " + util_shared_styles_1.akColorN30 + ";";
});
