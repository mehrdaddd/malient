...
var LocalUploadComponent = /** @class */ (function (_super) {
    ...
    function LocalUploadComponent(analyticsContext, context, config) {
        var _this = _super.call(this, analyticsContext) || this;
        ...
        _this.onFileUploading = function (_a) {
            ...
            _this.emitUploadProgress(file, progress.toJSON());
        };
        _this.onFileConverting = function (_a) {
            var file = _a.file;
            _this.emitUploadProcessing(file);
        };
        _this.onFileConverted = function (_a) {
            var file = _a.file, metadata = _a.metadata;
            _this.emitUploadEnd(file, metadata);
        };
        _this.onUploadError = function (_a) {
            var file = _a.file, error = _a.error;
            _this.emitUploadError(file, error);
        };
        var _a = context.config, userAuthProvider = _a.userAuthProvider, authProvider = _a.authProvider, serviceHost = _a.serviceHost;
        _this.context = context;
        _this.uploadService = new uploadService_1.UploadService(serviceHost, authProvider, config.uploadParams || { collection: '' }, userAuthProvider);
