...
var MentionResource = /** @class */ (function (_super) {
    ...
    function MentionResource(config) {
        ...
        _this.searchIndex = new SearchIndex();
    ...
    MentionResource.prototype.recordMentionSelection = function (mention) {
        return this.recordSelection(mention).then(function () { }, function (error) { return debug("error recording mention selection: " + error, error); });
    };
    ...
    MentionResource.prototype.sortMentionsResult = function (mentionsResult) {
        return this.getUserIdsInContext().then(function (userIdsInContext) {
            return tslib_1.__assign({}, mentionsResult, { mentions: mentionsResult.mentions.sort(mentionDescriptionComparator(userIdsInContext)) });
        });
    };
