...
function createSearchEmojiComparator(query, orderedIds) {
    ...
    var comparator = new (ChainedEmojiComparator.bind.apply(ChainedEmojiComparator, [void 0].concat(comparators)))();
...
var UsageFrequencyComparator = /** @class */ (function () {
    ...
    UsageFrequencyComparator.prototype.getPositionInOrder = function (emoji) {
        ...
        if (type_helpers_1.isEmojiVariationDescription(emoji)) {
            id = emoji.baseId;
        }
        ...
        if (position) {
            ...
            return constants_1.MAX_ORDINAL;
        }
    };
...
var QueryStringPositionMatchComparator = /** @class */ (function () {
    ...
    QueryStringPositionMatchComparator.prototype.compare = function (e1, e2) {
        var i1 = e1[this.propertyName]
            ? e1[this.propertyName].indexOf(this.query)
            : constants_1.MAX_ORDINAL;
        var i2 = e2[this.propertyName]
            ? e2[this.propertyName].indexOf(this.query)
            : constants_1.MAX_ORDINAL;
        i1 = i1 === -1 ? constants_1.MAX_ORDINAL : i1;
        i2 = i2 === -1 ? constants_1.MAX_ORDINAL : i2;
        return i1 - i2;
    };
...
var OrderComparator = /** @class */ (function () {
    ...
    OrderComparator.prototype.compare = function (e1, e2) {
        var o1 = e1.order ? e1.order : constants_1.MAX_ORDINAL;
        var o2 = e2.order ? e2.order : constants_1.MAX_ORDINAL;
        return o1 - o2;
    };
