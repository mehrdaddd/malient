...
var MediaEmojiCache_1 = require("./MediaEmojiCache");
...
var SiteEmojiResource = /** @class */ (function () {
    function SiteEmojiResource(siteServiceConfig, mediaApiToken) {
        var _this = this;
        this.postToEmojiService = function (upload, mediaApiData) {
            ...
            return util_service_support_1.utils
                ...
                if (emojis.length) {
                    ...
                    var response_1 = tslib_1.__assign({}, emoji, { representation: type_helpers_1.convertImageToMediaRepresentation(emoji.representation) });
    ...
    SiteEmojiResource.prototype.uploadEmoji = function (upload, progressCallback) {
        ...
        return this.tokenManager.getToken('upload').then(function (uploadToken) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                var context = media_core_1.ContextFactory.create({
                    serviceHost: url,
                ...
                var mpBinary = _this.createMediaPicker(context, mpConfig);
                mpBinary.on('upload-end', function (result) {
                    ...
                    _this.postToEmojiService(upload, result.public)
                        .then(function (emoji) {
                        resolve(emoji);
                    })
                ...
                mpBinary.on('upload-error', function (errorResult) {
                    reject(errorResult.error);
                });
                mpBinary.on('upload-status-update', function (statusUpdate) {
                    logger_1.default('upload progress', statusUpdate.progress);
                    if (progressCallback) {
                        progressCallback({
                            percent: statusUpdate.progress.portion * exports.mediaProportionOfProgress,
                        });
                    }
                });
     ...
     */
    SiteEmojiResource.prototype.createMediaPicker = function (context, config) {
        return media_picker_1.MediaPicker('binary', context, config);
    };
