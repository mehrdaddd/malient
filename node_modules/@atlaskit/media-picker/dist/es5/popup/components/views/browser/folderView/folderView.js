...
var dateformat = require("dateformat"); // ToDo: FIL-3207 | replace dateformat library with native solution
var filesize = require("filesize"); // ToDo: FIL-3208 | replace filesize library with native solution
var check_circle_1 = require("@atlaskit/icon/glyph/check-circle");
    ...
    function FolderViewer() {
        ...
        _this.renderFileCreateDateAndSize = function (_a) {
            ...
            return (React.createElement(styled_1.FileMetadataGroup, null,
                ...
                React.createElement(styled_1.FileSize, null, filesize(size))));
        };
...
exports.default = react_redux_1.connect(function (_a) {
    var view = _a.view, accounts = _a.accounts, selectedItems = _a.selectedItems;
    return ({
        path: view.path,
        accounts: accounts,
