...
var App = /** @class */ (function (_super) {
    ...
    function App(props) {
        ...
        _this.mpBrowser = __1.MediaPicker('browser', _this.mpContext, tslib_1.__assign({}, defaultConfig, { multiple: true }));
        ...
        _this.mpDropzone = __1.MediaPicker('dropzone', _this.mpContext, tslib_1.__assign({}, defaultConfig, { headless: true }));
        ...
        _this.mpBinary = __1.MediaPicker('binary', _this.mpContext, defaultConfig);
...
var mapDispatchToProps = function (dispatch) { return ({
    onStartApp: function (onCancelUpload) { return dispatch(startApp_1.startApp({ onCancelUpload: onCancelUpload })); },
    onUploadsStart: function (_a) {
        var files = _a.files;
        return dispatch(fileUploadsStart_1.fileUploadsStart({
            files: files,
        }));
    },
    ...
    onUploadPreviewUpdate: function (_a) {
        ...
        dispatch(fileUploadPreviewUpdate_1.fileUploadPreviewUpdate({
            file: file,
            preview: preview,
        }));
    },
    onUploadStatusUpdate: function (_a) {
        ...
        return dispatch(fileUploadProgress_1.fileUploadProgress({
            file: file,
            progress: progress,
        }));
    },
    onUploadProcessing: function (_a) {
        var file = _a.file;
        return dispatch(fileUploadProcessingStart_1.fileUploadProcessingStart({
            file: file,
        }));
    },
    onUploadEnd: function (_a) {
        var file = _a.file, publicFileDetails = _a.public;
        return dispatch(fileUploadEnd_1.fileUploadEnd({
            file: file,
    ...
    onUploadError: function (_a) {
        ...
        return dispatch(fileUploadError_1.fileUploadError({
            file: file,
            error: error,
        }));
    },
