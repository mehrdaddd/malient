...
import { CollectionItem, Service, ServiceAccountWithType, ServiceFolder, ServiceName, SourceFile } from '../../domain';
...
export interface Fetcher {
    ...
    pollFile(apiUrl: string, auth: Auth, fileId: string, collection?: string): Promise<FileDetails>;
    ...
    copyFile(apiUrl: string, sourceFile: SourceFile, destination: CopyFileDestination, collection?: string): Promise<FileDetails>;
...
export declare class MediaApiFetcher implements Fetcher {
    ...
    getRecentFiles(apiUrl: string, auth: Auth, limit: number, sortDirection: string, inclusiveStartKey?: string): Promise<GetRecentFilesData>;
    unlinkCloudAccount(apiUrl: string, auth: Auth, accountId: string): Promise<void>;
    copyFile(apiUrl: string, sourceFile: SourceFile, {auth, collection}: CopyFileDestination): Promise<FileDetails>;
