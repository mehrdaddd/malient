...
var WsConnection = /** @class */ (function () {
    function WsConnection(apiUrl, auth, onDataReceived, onConnectionLost) {
        var _this = this;
        this.apiUrl = apiUrl;
        this.auth = auth;
        ...
        this.openWs = function () {
            ...
            try {
                ...
                _this.ws = new ws_1.Ws(_this.apiUrl, _this.auth, _this.wsDataReceived, _this.onConnectionLost);
