...
var uploadServiceFactory_1 = require("../service/uploadServiceFactory");
...
var LocalUploadComponent = /** @class */ (function (_super) {
    ...
    function LocalUploadComponent(analyticsContext, context, config) {
        ...
        _this.uploadService = uploadServiceFactory_1.UploadServiceFactory.create(_this.context, config.uploadParams || { collection: '' }, config.useNewUploadService);
