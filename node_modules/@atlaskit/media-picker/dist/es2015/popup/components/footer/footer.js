...
var Footer = /** @class */ (function (_super) {
    ...
    Footer.prototype.renderCancelButton = function () {
        ...
        return (React.createElement(CancelButton, { appearance: "subtle", onClick: onCancel, isDisabled: !canCancel }, "Cancel"));
    };
    Footer.prototype.renderInsertButton = function () {
        ...
        return (React.createElement(InsertButton, { appearance: "primary", onClick: onClick, isDisabled: !canInsert }, "Insert  " + itemCount + " " + (itemCount === 1 ? 'file' : 'files')));
    };
...
var mapDispatchToProps = function (dispatch) { return ({
    onInsert: function (selectedItems) { return dispatch(startImport()); },
