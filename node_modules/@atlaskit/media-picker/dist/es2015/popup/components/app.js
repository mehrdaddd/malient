...
var App = /** @class */ (function (_super) {
    ...
    function App(props) {
        ...
        _this.mpBrowser = MediaPicker('browser', _this.mpContext, tslib_1.__assign({}, defaultConfig, { multiple: true }));
        ...
        _this.mpDropzone = MediaPicker('dropzone', _this.mpContext, tslib_1.__assign({}, defaultConfig, { headless: true }));
        ...
        _this.mpBinary = MediaPicker('binary', _this.mpContext, defaultConfig);
...
var mapStateToProps = function (_a) {
    var view = _a.view, context = _a.context;
    return ({
...
var mapDispatchToProps = function (dispatch) { return ({
    onStartApp: function (onCancelUpload) { return dispatch(startApp({ onCancelUpload: onCancelUpload })); },
    onUploadsStart: function (_a) {
        var files = _a.files;
        return dispatch(fileUploadsStart({
            files: files,
        }));
    },
    onClose: function () { return dispatch(hidePopup()); },
    onUploadPreviewUpdate: function (_a) {
        var file = _a.file, preview = _a.preview;
        dispatch(fileUploadPreviewUpdate({
            file: file,
            preview: preview,
        }));
    },
    onUploadStatusUpdate: function (_a) {
        var file = _a.file, progress = _a.progress;
        return dispatch(fileUploadProgress({
            file: file,
            progress: progress,
        }));
    },
    onUploadProcessing: function (_a) {
        var file = _a.file;
        return dispatch(fileUploadProcessingStart({
            file: file,
        }));
    },
    onUploadEnd: function (_a) {
        var file = _a.file, publicFileDetails = _a.public;
        return dispatch(fileUploadEnd({
            file: file,
            public: publicFileDetails,
        }));
    },
    onUploadError: function (_a) {
