...
import { addAuthToQueryParameters, } from './mediaClient';
...
var MediaApi = /** @class */ (function () {
    ...
    MediaApi.prototype.createUpload = function (mediaClient) {
        ...
        return retryTask(function () {
            return mediaClient.call(request, addAuthToQueryParameters).then(function (response) {
    ...
    MediaApi.prototype.copyFileToCollection = function (mediaClient, sourceFile, collection) {
        ...
        return mediaClient.call(request, addAuthToQueryParameters).then(function () { });
    };
    return MediaApi;
}());
export { MediaApi };
