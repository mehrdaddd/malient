...
import { MediaItemType, MediaItemDetails, ImageResizeMode } from '@atlaskit/media-core';
...
export declare class CardViewBase extends React.Component<CardViewBaseProps, CardViewState> {
    private componentHasMountedAtTime;
    constructor(props: any);
    componentDidMount(): void;
    private fireShowedAnalyticsEvent({status});
 ...
 */
export declare const CardViewWithAnalyticsEvents: any;
/**
