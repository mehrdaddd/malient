...
var HTMLEmbedCard = /** @class */ (function (_super) {
    ...
    HTMLEmbedCard.prototype.render = function () {
        ...
        return (React.createElement(Iframe, { innerRef: this.handleIframeMount, onLoad: this.handleIframeLoad, style: this.style, isLoading: isLoading, allowFullScreen: true, src: "https://media-embed-iframe.prod.atl-paas.net/1.0.0" }));
    };
