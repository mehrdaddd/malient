...
import { BlockCardView } from '@atlaskit/smart-card';
...
export function convertAppCardToSmartCard(model) {
    return {
...
var AppCardViewV2 = /** @class */ (function (_super) {
    ...
    AppCardViewV2.prototype.render = function () {
        ...
        if (newDesign) {
            return (React.createElement(BlockCardView, tslib_1.__assign({}, convertAppCardToSmartCard(model), { onClick: onClick, actions: getActions(model, onActionClick) })));
        }
        else {
            return (React.createElement(AppCardView, { model: model, onClick: onClick, onActionClick: onActionClick }));
        }
    };
