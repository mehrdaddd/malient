...
var dialogBgColor = function dialogBgColor(_ref2) {
  ...
  return isChromeless ? 'transparent' : themed({ light: colors.N0, dark: colors.DN50 });
};
...
*/
export var FillScreen = styled.div(_templateObject, function (p) {
  return p.scrollDistance;
}, layers.modal);

export var PositionerAbsolute = styled.div(_templateObject2, maxHeightDimensions, maxDimensions, gutter, dialogWidth, layers.modal);
export var PositionerRelative = styled.div(_templateObject3, gutter, dialogWidth, layers.modal);

export var Dialog = styled.div(_templateObject4, function (p) {
  return p.isChromeless ? null : css(_templateObject5, dialogBgColor, borderRadius, boxShadow);
