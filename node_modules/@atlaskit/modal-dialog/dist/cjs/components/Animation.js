...
function Animation(_ref) {
  var Tag = _ref.component,
      ...
      props = (0, _objectWithoutProperties3.default)(_ref, ['component', 'in', 'onEnter', 'onEntering', 'onEntered', 'onExit', 'onExiting', 'onExited', 'style', 'styleDefault', 'customTransition', 'transition']);
  ...
  return _react2.default.createElement(
    ...
    function (status) {
      ...
      var styles = (0, _extends3.default)({}, style, styleDefault, transition[status], transition[customTransition]);

      return _react2.default.createElement(Tag, (0, _extends3.default)({ style: styles }, props));
    }
  );
}
...
var SlideUp = function SlideUp(_ref2) {
  var stackIndex = _ref2.stackIndex,
      ...
      props = (0, _objectWithoutProperties3.default)(_ref2, ['stackIndex', 'in', 'style', 'component']);
  ...
  return _react2.default.createElement(Animation, (0, _extends3.default)({
    ...
    transition: {
      ...
      afterEntered: {
        transform: null,
        top: translateY + (component.displayName === 'PositionerAbsolute' ? _sharedVariables.gutter : 0)
      },
      exit: {
        transform: restingTransform
      },
