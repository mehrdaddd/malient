...
var Calendar = function (_Component) {
  ...
  function Calendar(props) {
    ...
    var _this = _possibleConstructorReturn(this, (Calendar.__proto__ || _Object$getPrototypeOf(Calendar)).call(this, props));

    _this.getState = function () {
      return _extends({}, _this.state, pick(_this.props, ['day', 'disabled', 'selected', 'month', 'previouslySelected', 'year', 'today']));
    };
    ...
    _this.handleClickNext = function () {
      var _this$getState$_this$ = _extends({}, _this.getState(), _this.getNextMonth()),
    ...
    _this.handleClickPrev = function () {
      var _this$getState$_this$2 = _extends({}, _this.getState(), _this.getPrevMonth()),
    ...
    _this.getCalendarWeeks = function (mappedState) {
      ...
      if (shouldDisplaySixthWeek) {
        ...
        calendar.push.apply(calendar, _toConsumableArray(_this.calendar.getCalendar(year, month).slice(sliceStart, sliceStart + daysPerWeek).map(function (e) {
          return _extends({}, e, { siblingMonth: true });
        })));
      }
      ...
      calendar.forEach(function (date) {
        ...
        week.components.push(React.createElement(
          DateComponent,
          {
            disabled: isDisabled,
            focused: isFocused,
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                'tr',
                null,
                makeArrayFromNumber(daysPerWeek).map(function (i) {
                  return React.createElement(
                    CalendarTh,
                    { key: i },
                    getShortDayName(i)
