...
var EmojiPlaceholder = function (props) {
    var shortName = props.shortName, _a = props.size, size = _a === void 0 ? defaultEmojiHeight : _a, showTooltip = props.showTooltip, representation = props.representation;
    var scaledWidth;
    var scaledHeight;
    if (representation &&
        size &&
