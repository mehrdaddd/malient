...
var EmojiPickerVirtualList = /** @class */ (function (_super) {
    ...
    EmojiPickerVirtualList.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: "root", className: classNames(classes), onMouseLeave: onMouseLeave, onMouseEnter: onMouseEnter },
            React.createElement(VirtualList, { ref: "list", height: sizes.listHeight, overscanRowCount: 5, rowCount: this.virtualItems.length, rowHeight: this.rowSize, rowRenderer: this.renderRow, scrollToAlignment: "start", width: sizes.listWidth, className: styles.virtualList, onRowsRendered: this.checkCategoryChange })));
    };
