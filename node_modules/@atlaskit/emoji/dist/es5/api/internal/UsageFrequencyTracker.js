...
var DuplicateLimitedQueue_1 = require("../../DuplicateLimitedQueue");
var StoredDuplicateLimitedQueue_1 = require("../../StoredDuplicateLimitedQueue");
/**
...
var UsageFrequencyTracker = /** @class */ (function () {
    function UsageFrequencyTracker() {
        ...
        if (options.storage) {
            ...
            this.queue = new StoredDuplicateLimitedQueue_1.default(queueOptions);
        }
        else {
            this.queue = new DuplicateLimitedQueue_1.default(options);
        }
    ...
    UsageFrequencyTracker.queueOptions = {
        ...
        storagePrefix: constants_1.localStoragePrefix,
        maxDuplicates: 25,
        minUniqueItems: 5,
    };
