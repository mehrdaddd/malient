...
import { EmojiDescription, EmojiId, EmojiResponse, EmojiSearchResult, EmojiUpload, OptionalEmojiDescription, SearchOptions, ToneSelection, User, OptionalUser } from '../types';
...
export interface EmojiProvider extends Provider<string, EmojiSearchResult, any, undefined, SearchOptions> {
     ...
     */
    setSelectedTone(tone: ToneSelection): any;
    /**
