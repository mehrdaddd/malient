...
var EmojiUploadPreview_1 = require("./EmojiUploadPreview");
    ...
    ChooseEmojiFile.prototype.render = function () {
        ...
        return (React.createElement("div", { className: styles.emojiUpload },
            React.createElement("div", { className: styles.uploadChooseFileMessage },
                React.createElement("h5", null, "Add your own emoji")),
            React.createElement("div", { className: styles.uploadChooseFileRow },
                React.createElement("span", { className: styles.uploadChooseFileEmojiName },
                    React.createElement(field_base_1.default, { appearance: "standard", isCompact: true, isLabelHidden: true, isFocused: true, isFitContainerWidthEnabled: true },
                        React.createElement("input", { placeholder: "Emoji name", maxLength: maxNameLength, onChange: onNameChange, onKeyDown: this.onKeyDown, value: name, ref: "name", autoFocus: true }))),
                React.createElement("span", { className: styles.uploadChooseFileBrowse },
                    React.createElement(FileChooser_1.default, { label: "Choose file", onChange: onChooseFile, accept: "image/png,image/jpeg,image/gif", isDisabled: disableChooser }))),
            React.createElement("div", { className: styles.emojiUploadBottom }, !errorMessage ? (React.createElement("p", null, "JPG, PNG or GIF. Max size 1 MB.")) : (React.createElement(EmojiErrorMessage_1.default, { className: styles.emojiChooseFileErrorMessage, message: errorMessage })))));
    };
...
var EmojiUploadPicker = /** @class */ (function (_super) {
    ...
    EmojiUploadPicker.prototype.render = function () {
        ...
        if (name && previewImage) {
            return (React.createElement(EmojiUploadPreview_1.default, { errorMessage: errorMessage, name: name, onAddEmoji: this.onAddEmoji, onUploadCancelled: onUploadCancelled, previewImage: previewImage, uploadStatus: uploadStatus }));
        }
        return (React.createElement(ChooseEmojiFile, { name: name, onChooseFile: this.onChooseFile, onNameChange: this.onNameChange, onUploadCancelled: onUploadCancelled, errorMessage: chooseEmojiErrorMessage }));
    };
