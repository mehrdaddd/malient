...
var FileChooser = /** @class */ (function (_super) {
    ...
    FileChooser.prototype.render = function () {
        var _a = this.props, accept = _a.accept, isDisabled = _a.isDisabled, label = _a.label, onChange = _a.onChange;
        return (React.createElement("span", null,
            React.createElement(button_1.default, { onClick: this.onChooseFile, isDisabled: isDisabled }, label),
