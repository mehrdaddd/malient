...
var EmojiTypeAheadItem_1 = require("./EmojiTypeAheadItem");
var Scrollable_1 = require("../common/Scrollable");
...
var EmojiTypeAheadList = /** @class */ (function (_super) {
    ...
    function EmojiTypeAheadList(props) {
        ...
        _this.selectIndexOnHover = function (emojiId, emoji, event) {
    ...
    EmojiTypeAheadList.prototype.renderItems = function (emojis) {
        ...
        if (emojis && emojis.length) {
            ...
            return (React.createElement("div", null, emojis.map(function (emoji, idx) {
                ...
                var item = (React.createElement(EmojiTypeAheadItem_1.default, { emoji: emoji, key: key, selected: _this.isSelectedEmoji(emoji, idx), onMouseMove: _this.selectIndexOnHover, onSelection: _this.itemSelected, 
    ...
    EmojiTypeAheadList.prototype.render = function () {
        var _a = this.props, emojis = _a.emojis, loading = _a.loading;
        var hasEmoji = emojis && emojis.length;
        var classes = classNames((_b = {
                'ak-emoji-typeahead-list': true
            },
            _b[styles.typeAheadList] = true,
            _b[styles.typeAheadEmpty] = !hasEmoji && !loading,
            _b));
        var listBody;
        if (loading) {
