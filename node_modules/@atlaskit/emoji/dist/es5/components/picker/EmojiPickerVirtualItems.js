...
var EmojiPickerListSearch_1 = require("./EmojiPickerListSearch");
var EmojiPickerEmojiRow_1 = require("./EmojiPickerEmojiRow");
var EmojiPickerCategoryHeading_1 = require("./EmojiPickerCategoryHeading");
...
var EmojisRowItem = /** @class */ (function (_super) {
    ...
    function EmojisRowItem(props) {
        ...
        _this.renderItem = function (context) { return (React.createElement(EmojiPickerEmojiRow_1.default, tslib_1.__assign({}, _this.props))); };
        return _this;
    }
