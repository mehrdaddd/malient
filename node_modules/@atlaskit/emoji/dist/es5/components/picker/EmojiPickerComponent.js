...
var EmojiPickerList_1 = require("./EmojiPickerList");
...
var EmojiPickerComponent = /** @class */ (function (_super) {
    ...
    function EmojiPickerComponent(props) {
        ...
        _this.onEmojiActive = function (emojiId, emoji) {
        ...
        _this.fireAnalytics = function (eventName, data) {
            ...
            if (firePrivateAnalyticsEvent) {
                firePrivateAnalyticsEvent(constants_1.analyticsEmojiPrefix + "." + eventName, data);
            }
        };
        ...
        _this.updateEmojis = function (query, options) {
            ...
            if (!query) {
                ...
                var frequentOptions = tslib_1.__assign({}, options, { sort: 0 /* None */, limit: FREQUENTLY_USED_MAX });
        ...
        _this.onUploadEmoji = function (upload) {
            ...
            if (EmojiResource_1.supportsUploadFeature(emojiProvider)) {
                emojiProvider
                    ...
                    _this.fireAnalytics('upload.failed');
                });
            }
        };
        _this.onTriggerDelete = function (emojiId, emoji) {
    ...
    EmojiPickerComponent.prototype.componentDidUpdate = function (prevProps, prevState) {
    ...
    EmojiPickerComponent.prototype.buildQuerySpecificEmojiList = function (query, searchEmoji, frequentEmoji) {
        ...
        return searchEmoji.concat(frequentEmoji);
    };
    /**
    ...
    EmojiPickerComponent.prototype.render = function () {
        ...
        var picker = (React.createElement("div", { className: classNames(classes), ref: this.handlePickerRef },
            ...
            React.createElement(EmojiPickerFooter_1.default, { initialUploadName: query, selectedEmoji: selectedEmoji, selectedTone: selectedTone, onToneSelected: this.onToneSelected, toneEmoji: toneEmoji, uploading: uploading, emojiToDelete: emojiToDelete, uploadErrorMessage: uploadErrorMessage, uploadEnabled: uploadSupported && showUploadButton && !uploading, onUploadEmoji: this.onUploadEmoji, onUploadCancelled: this.onUploadCancelled, onDeleteEmoji: this.onDeleteEmoji, onCloseDelete: this.onCloseDelete, onFileChosen: this.onFileChosen, onOpenUpload: this.onOpenUpload })));
        return picker;
    };
