...
export declare const emojiPickerBorderColor: any;
...
export declare const noDialogContainerBorderColor: any;
export declare const noDialogContainerBorderRadius: any;
export declare const noDialogContainerBoxShadow = "0 3px 6px rgba(0, 0, 0, 0.2)";
export declare const akEmojiSelectedBackgroundColor: any;
export declare const emojiPreviewSelectedColor: any;
