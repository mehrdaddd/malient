...
export var changeCloudAccountFolderMiddleware = function (fetcher) { return function (store) { return function (next) { return function (action) {
    if (isChangeCloudAccountFolderAction(action)) {
        ...
        var apiUrl_1 = store.getState().apiUrl;
        ...
        userAuthProvider()
            .then(function (auth) {
            return fetcher.fetchCloudAccountFolder(apiUrl_1, auth, serviceName_1, accountId_1, lastPath_1.id);
        })
            .then(function (folder) {
            return store.dispatch(fileListUpdate(accountId_1, path_1, folder.items, undefined, folder.cursor));
        })
