...
import { UploadServiceFactory, } from '../service/uploadServiceFactory';
...
var LocalUploadComponent = /** @class */ (function (_super) {
    ...
    function LocalUploadComponent(analyticsContext, context, config) {
        ...
        _this.uploadService = UploadServiceFactory.create(_this.context, config.uploadParams || { collection: '' }, config.useNewUploadService);
        _this.config = config;
