...
var MediaEditor = /** @class */ (function (_super) {
    ...
    MediaEditor.prototype.render = function () {
        ...
        return (React.createElement(EditorContainer, { style: { width: width, height: height } },
            React.createElement(OutputArea, { innerRef: this.handleOutputAreaInnerRef, style: { width: width, height: height } },
                ...
                React.createElement(DrawingCanvas, { innerRef: this.handleDrawingCanvasInnerRef, style: { width: width, height: height } }))));
    };
