...
export declare class Typeset implements Core.TypesetInterop {
    ...
    getDescent(): number;
    private destroy();
    private bindFragmentTexture(index, bindMethod);
    private getFragmentCoordinate(index, getter);
    private updateParagraphs(text, direction, fontSize);
    private collectParagraphData(cursorArray, cursorPosCount);
    private collectFragments();
    private collectCursorPositions(cursorArray, cursorPosCount);
}
