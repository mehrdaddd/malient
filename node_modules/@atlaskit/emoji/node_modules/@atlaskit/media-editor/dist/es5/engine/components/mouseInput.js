...
var DefaultMouseInput = /** @class */ (function () {
    function DefaultMouseInput(inputArea, positionCalculator) {
        ...
        this.click = new signal_1.Signal();
        this.dragStart = new signal_1.Signal();
        this.dragMove = new signal_1.Signal();
        this.dragEnd = new signal_1.Signal();
        this.dragLost = new signal_1.Signal();
...
exports.DefaultMouseInput = DefaultMouseInput;
