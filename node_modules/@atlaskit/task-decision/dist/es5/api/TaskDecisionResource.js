...
var RecentUpdates = /** @class */ (function () {
    function RecentUpdates(pubSubClient) {
        ...
        this.onPubSubEvent = function (event, payload) {
...
var ItemStateManager = /** @class */ (function () {
    function ItemStateManager(serviceConfig) {
        ...
        this.onTaskUpdatedEvent = function (event, payload) {
            ...
            if (lastUpdateDate > cached.lastUpdateDate) {
                _this.cachedItems.set(key, TaskDecisionUtils_1.convertServiceTaskStateToBaseItem(payload));
    ...
    ItemStateManager.prototype.toggleTask = function (objectKey, state) {
        ...
        return new Promise(function (resolve, reject) {
            _this.debouncedTaskToggle.set(stringKey, setTimeout(function () {
                var options = {
                    path: 'tasks',
                    requestInit: {
                        method: 'PUT',
    ...
    ItemStateManager.prototype.scheduleGetTaskState = function () {
        ...
        this.debouncedTaskStateQuery = setTimeout(function () {
            _this.getTaskState(Array.from(_this.batchedKeys.values())).then(function (tasks) {
                tasks.forEach(function (task) {
                    ...
                    var objectKey = { containerAri: containerAri, objectAri: objectAri, localId: localId };
                    _this.cachedItems.set(type_helpers_1.objectKeyToString(objectKey), TaskDecisionUtils_1.convertServiceTaskStateToBaseItem(task));
...
var TaskDecisionResource = /** @class */ (function () {
    ...
    TaskDecisionResource.prototype.getDecisions = function (query, recentUpdatesListener) {
        return this.query(query, 'decisions/query', TaskDecisionUtils_1.convertServiceDecisionResponseToDecisionResponse, recentUpdatesListener);
    };
    TaskDecisionResource.prototype.getTasks = function (query, recentUpdatesListener) {
        return this.query(query, 'tasks/query', TaskDecisionUtils_1.convertServiceTaskResponseToTaskResponse, recentUpdatesListener);
    };
    TaskDecisionResource.prototype.getItems = function (query, recentUpdatesListener) {
        return this.query(query, 'elements/query', TaskDecisionUtils_1.convertServiceItemResponseToItemResponse, recentUpdatesListener);
    };
    ...
    TaskDecisionResource.prototype.apiQueryToServiceQuery = function (query) {
        ...
        var serviceQuery = tslib_1.__assign({}, other, { limit: limit || constants_1.defaultLimit });
        switch (sortCriteria) {
            case 'lastUpdateDate':
