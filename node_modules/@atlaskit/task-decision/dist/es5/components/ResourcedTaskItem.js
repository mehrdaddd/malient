...
var ResourcedTaskItem = /** @class */ (function (_super) {
    ...
    ResourcedTaskItem.prototype.render = function () {
        ...
        var _b = this.props, appearance = _b.appearance, children = _b.children, contentRef = _b.contentRef, creator = _b.creator, participants = _b.participants, showParticipants = _b.showParticipants, showPlaceholder = _b.showPlaceholder, taskId = _b.taskId;
        return (React.createElement(TaskItem_1.default, { isDone: isDone, taskId: taskId, onChange: this.handleOnChange, appearance: appearance, contentRef: contentRef, participants: participants, showParticipants: showParticipants, showPlaceholder: showPlaceholder, creator: creator, lastUpdater: lastUpdater }, children));
    };
