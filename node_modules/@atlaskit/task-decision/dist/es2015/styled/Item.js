...
export var Wrapper = styled.div(templateObject_2 || (templateObject_2 = tslib_1.__makeTemplateObject(["\n  display: flex;\n  flex-direction: ", ";\n\n  background-color: ", ";\n  border-radius: ", "px;\n  margin: ", "px 0;\n  padding: ", "px ", "px;\n  min-height: 36px;\n  box-sizing: border-box;\n  box-shadow: ", ";\n\n  &:hover {\n    box-shadow: ", ";\n    transition: box-shadow 0.2s ease-in-out;\n  }\n"], ["\n  display: flex;\n  flex-direction: ",
    ...
    ";\n\n  &:hover {\n    box-shadow: ",
    ";\n    transition: box-shadow 0.2s ease-in-out;\n  }\n"])), function (props) {
    return props.theme.appearance === 'card' ? 'column' : 'row';
}, colors.N20, borderRadius(), akGridSize, akGridSize, akGridSize, function (props) {
    return props.theme.appearance === 'card'
