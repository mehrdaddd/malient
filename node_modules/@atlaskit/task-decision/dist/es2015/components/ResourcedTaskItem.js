...
var ResourcedTaskItem = /** @class */ (function (_super) {
    ...
    ResourcedTaskItem.prototype.render = function () {
        ...
        var _b = this.props, appearance = _b.appearance, children = _b.children, contentRef = _b.contentRef, creator = _b.creator, participants = _b.participants, showParticipants = _b.showParticipants, showPlaceholder = _b.showPlaceholder, taskId = _b.taskId, taskDecisionProvider = _b.taskDecisionProvider;
        return (React.createElement(TaskItem, { isDone: isDone, taskId: taskId, onChange: this.handleOnChange, appearance: appearance, contentRef: contentRef, participants: participants, showParticipants: showParticipants, showPlaceholder: showPlaceholder, creator: creator, lastUpdater: lastUpdater, disabled: !taskDecisionProvider }, children));
    };
