...
var InternalTaskItem = /** @class */ (function (_super) {
    ...
    InternalTaskItem.prototype.render = function () {
        var _a = this.props, appearance = _a.appearance, isDone = _a.isDone, contentRef = _a.contentRef, children = _a.children, participants = _a.participants, showPlaceholder = _a.showPlaceholder, disabled = _a.disabled;
        var icon = (React.createElement(CheckBoxWrapper, { contentEditable: false },
            React.createElement("input", { id: this.checkBoxId, name: this.checkBoxId, type: "checkbox", onChange: this.handleOnChange, checked: !!isDone, disabled: !!disabled }),
