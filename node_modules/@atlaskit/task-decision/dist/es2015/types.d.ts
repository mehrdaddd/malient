...
export interface RecentUpdatesListener {
     ...
     */
    recentUpdates(updateContext: RecentUpdateContext): any;
}
...
export interface TaskDecisionProvider {
    ...
    unsubscribeRecentUpdates(id: RecentUpdatesId): any;
    notifyRecentUpdates(updateContext: RecentUpdateContext): any;
